...
var RDBContext = createContext(defaultConfig);
var RDBProvider = ({
  children,
  config,
  actions
  ...
  return /* @__PURE__ */ jsx(RDBContext.Provider, { value: contextValue, children });
};
var useRDBContext = () => useContext(RDBContext);
var useRDBConfig = () => {
...
var UniversalRouterContext = createContext2(null);
var useUniversalRouter = () => {
  const context = useContext2(UniversalRouterContext);
...
var LibraryRouterAdapter = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx2(UniversalRouterContext.Provider, { value, children });
};
...
var LayoutContext = createContext4(void 0);
...
var StoreContext = createContext5(void 0);
...
function StoreProvider({ children }) {
  ...
  const [currencies, setCurrencies] = useState3([]);
  const [metals, setMetals] = useState3([]);
  const [balances, setBalances] = useState3({});
  const [account, setAccount] = useState3({ name: "", type: "", number: "" });
  const [balanceHidden, setBalanceHidden] = useState3(false);
  const [activeAssetSymbol, setActiveAssetSymbol] = useState3(void 0);
  const [activeAssetType, setActiveAssetType] = useState3(void 0);
  const [transactions, setTransactions] = useState3([]);
  const [purposes, setPurposes] = useState3([]);
  const [isDataLoaded, setIsDataLoaded] = useState3(false);
  const [isLoadingCurrencies, setIsLoadingCurrencies] = useState3(false);
  const [isLoadingMetals, setIsLoadingMetals] = useState3(false);
  const [isLoadingBalances, setIsLoadingBalances] = useState3(false);
  const [isLoadingTransactions, setIsLoadingTransactions] = useState3(false);
  const [isLoadingMoreTransactions, setIsLoadingMoreTransactions] = useState3(false);
  const [transactionPage, setTransactionPage] = useState3(0);
  const [transactionHasMore, setTransactionHasMore] = useState3(false);
  const [isLoadingPurposes, setIsLoadingPurposes] = useState3(false);
  const preloadStartedRef = useRef(false);
  const previousUserKeyRef = useRef(null);
  const resetStore = useCallback2(() => {
  ...
  const preloadData = useCallback2(
  ...
  const refreshTransactions = useCallback2(async (actions) => {
    if (!actions) return;
    setIsLoadingTransactions(true);
    try {
      const transactionsRes = await actions.transactions.GetFinancialLedger({ page: 0, limit: 10 });
  ...
  const loadMoreTransactions = useCallback2(async (actions) => {
  ...
  const refreshBalances = useCallback2(async (actions) => {
    if (!actions) return;
    setIsLoadingBalances(true);
    try {
...
function useStore() {
  const context = useContext5(StoreContext);
  if (context === void 0) {
...
function ClientProviders({
  ...
  return /* @__PURE__ */ jsx6("div", { className: "relative bg-background h-full w-full max-h-full max-w-full overflow-hidden flex flex-col shadow-none", children });
}
...
var RDBLayout = ({
  ...
  return (
    ...
    /* @__PURE__ */ jsx7("div", { className: `antialiased overflow-hidden bg-background flex items-center justify-center h-full w-full font-quicksand`, children: /* @__PURE__ */ jsx7(ClientProviders, { onSplashCompleteAction, children }) })
  );
};

// src/components/home/index.tsx
import { useState as useState19, useCallback as useCallback14 } from "react";
...
import { createContext as createContext6, useContext as useContext6, useState as useState4, useCallback as useCallback3, useEffect as useEffect5, useMemo as useMemo2 } from "react";
...
var I18nContext = createContext6(void 0);
function I18nProvider({ children, locale }) {
  ...
  const [language, setLanguageState] = useState4(resolveInitial);
  useEffect5(() => {
    if (isLibraryMode) {
  ...
  const translations2 = useMemo2(() => getTranslations(language), [language]);
  const tr2 = useCallback3(
    (key, params) => {
  ...
  return /* @__PURE__ */ jsx8(I18nContext.Provider, { value, children });
}
...
var NavHome = ({ activeAssetSymbol }) => {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "w-full h-6 pt-2 pl-6 pr-3 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsx9("span", { className: "font-quicksand font-bold text-[11px] text-[#1D1D1D] leading-4", children: totalBalanceLabel }),
      /* @__PURE__ */ jsx9(
        "button",
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 cursor-pointer", children: [
      /* @__PURE__ */ jsx9("div", { className: "relative w-4 h-4", children: /* @__PURE__ */ jsx9(Image, { src: icon, alt: icon, fill: true, className: "object-contain" }) }),
      /* @__PURE__ */ jsx9("span", { className: "font-quicksand font-normal text-[11px] text-[#388CFF] leading-4", children: addCurrencyLabel })
    ] })
  ] });
};
...
import { useEffect as useEffect6, useState as useState5, useCallback as useCallback4 } from "react";
...
var BalanceCard = ({
  ...
  const animationStyles = useMemo3(
    () => ({
  ...
  const transitionConfig = useMemo3(
    () => ({
  ...
  return /* @__PURE__ */ jsx10("div", { className: "p-0.5", children: /* @__PURE__ */ jsxs2(
    motion.div,
    {
      layout: true,
      ...
      children: [
        /* @__PURE__ */ jsx10(motion.div, { className: "w-full flex items-start justify-between gap-3", layout: true, children: /* @__PURE__ */ jsxs2(motion.div, { className: "flex flex-col gap-2", layout: true, children: [
          /* @__PURE__ */ jsx10("div", { className: "relative w-4 h-4", children: /* @__PURE__ */ jsx10(Image2, { src: icon, alt: currencyName, fill: true, className: "object-contain" }) }),
          /* @__PURE__ */ jsx10("span", { className: "font-quicksand font-light text-[11px] text-[#FFFFFF] leading-tight", children: currencyName })
        ] }) }),
        /* @__PURE__ */ jsxs2(motion.div, { className: "w-full flex items-end justify-between", layout: true, children: [
          /* @__PURE__ */ jsxs2("div", { className: "flex items-baseline gap-1", children: [
            ...
            /* @__PURE__ */ jsx10("span", { className: "font-quicksand font-light text-[9px] bottom-0 text-[#FFFFFF] uppercase", children: currencyCode })
          ] }),
          /* @__PURE__ */ jsx10(AnimatePresence, { children: isActive && /* @__PURE__ */ jsxs2(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs2(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx10("div", { className: "relative w-3.75 h-3.75", children: /* @__PURE__ */ jsx10(
                        Image2,
                        {
                      ...
                      /* @__PURE__ */ jsx10("span", { className: "font-quicksand font-light text-[8px] text-[#FFFFFF]", children: "statistic" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs2(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx10("span", { className: "font-quicksand font-light text-[8px] text-[#FFFFFF]", children: "Chart" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxs2(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx10("span", { className: "font-quicksand font-light text-[8px] text-[#FFFFFF]", children: "Info" })
                    ]
                  }
                )
              ]
...
import { motion as motion2, AnimatePresence as AnimatePresence2, LayoutGroup } from "framer-motion";
...
var BalanceHome = ({
  ...
  const [loadedSymbols, setLoadedSymbols] = useState5(/* @__PURE__ */ new Set());
  useEffect6(() => {
  ...
  if (isLoadingCurrencies || currencies.length === 0 && !isDataLoaded) {
    return /* @__PURE__ */ jsx11("div", { className: "w-full flex items-center gap-1.25 overflow-x-auto pl-3 pr-6 pb-4 no-scrollbar h-38", children: /* @__PURE__ */ jsx11(CurrenciesSkeletons, {}) });
  }
  ...
  return /* @__PURE__ */ jsx11(LayoutGroup, { children: /* @__PURE__ */ jsx11(
    motion2.div,
    {
      className: "w-full flex items-center overflow-x-auto pl-3 pr-6 pb-4 no-scrollbar h-38",
      layout: "position",
      children: /* @__PURE__ */ jsx11(AnimatePresence2, { mode: "popLayout", children: displayList.map((asset, index) => renderCard(asset, index)) })
    }
  ) });
};
var balance_default = BalanceHome;
var CurrenciesSkeletons = () => {
  return /* @__PURE__ */ jsx11(Fragment2, { children: Array.from({ length: 4 }).map((_c, index) => /* @__PURE__ */ jsx11("div", { className: "snap-center shrink-0 w-50 h-30", children: /* @__PURE__ */ jsx11(
    Skeleton,
    {
      borderRadius: 12,
...
import { useState as useState6, useMemo as useMemo4, useRef as useRef3, useEffect as useEffect7 } from "react";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-center gap-1", children: [
            /* @__PURE__ */ jsx12("div", { className: "relative w-4 h-4", children: /* @__PURE__ */ jsx12(Image3, { src: icon, alt: title, fill: true, className: "object-contain" }) }),
            /* @__PURE__ */ jsx12("div", { className: "relative w-3.5 h-3.5", children: /* @__PURE__ */ jsx12(Image3, { src: arrowIcon, alt: "arrow", fill: true, className: "object-contain" }) })
          ] }),
          /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-start", children: [
            /* @__PURE__ */ jsx12("span", { className: "font-quicksand font-medium text-[13px] text-[#1D1D1D] leading-tight", children: title }),
            /* @__PURE__ */ jsxs3("div", { className: "flex items-center gap-1 mt-1", children: [
              /* @__PURE__ */ jsx12("span", { className: "font-quicksand font-light text-[11px] text-[#A0A0A0]", children: date }),
              /* @__PURE__ */ jsx12("span", { className: "font-quicksand font-normal text-[11px] text-[#8D8D8D]", children: description })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-end", children: [
          /* @__PURE__ */ jsxs3("div", { className: "flex items-baseline gap-1", children: [
            /* @__PURE__ */ jsxs3("span", { className: "font-quicksand font-bold text-[13px] text-[#1D1D1D]", children: [
              isNegative ? "-" : "",
              amount
            ] }),
            /* @__PURE__ */ jsx12("span", { className: "font-quicksand font-bold text-[13px] text-[#1D1D1D]", children: currency })
          ] }),
          /* @__PURE__ */ jsx12("span", { className: "font-quicksand font-normal text-[11px] text-[#1D1D1D]", children: status })
        ] })
      ]
    }
  );
...
var TransactionsHome = ({
  ...
  const formattedTransactions = useMemo4(() => {
    const arr = [];
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "w-full px-3 mt-[px] flex flex-col flex-1 overflow-hidden items-start", children: [
    /* @__PURE__ */ jsx13("h2", { className: "font-quicksand font-bold ml-3.75 text-[11px] text-[#1D1D1D] mb-2.25 shrink-0", children: currentCurrency ? t.home.allTransactionsWithCurrency.replace("{{currency}}", currentCurrency) : t.home.allTransactions }),
    /* @__PURE__ */ jsxs4("div", { className: "flex w-full flex-col gap-1.25 overflow-y-auto flex-1 no-scrollbar px-px py-px", children: [
      isLoadingTransactions && Array.from({ length: 10 }).map((_, i) => /* @__PURE__ */ jsx13(
        Skeleton2,
        {
          width: 400,
          className: "w-full",
      ...
      formattedTransactions.map((tx) => /* @__PURE__ */ jsx13(
      ...
      isLoadingMoreTransactions && Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsx13(
        Skeleton2,
        {
          width: 400,
          className: "w-full",
      ...
      /* @__PURE__ */ jsx13("div", { ref: sentinelRef, className: "h-1 shrink-0" })
    ] })
  ] });
};
...
function CustomQRCode({
  ...
  const svgElements = useMemo5(() => {
    ...
    for (let row = 0; row < moduleCount; row++) {
      for (let col = 0; col < moduleCount; col++) {
        ...
        elements.push(/* @__PURE__ */ jsx14("path", { d, fill: "black" }, `d-${row}-${col}`));
      }
    }
  ...
  if (!svgElements) {
    return /* @__PURE__ */ jsx14("div", { style: { width: size, height: size } });
  }
  return /* @__PURE__ */ jsxs5(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx14("rect", { width: size, height: size, fill: bg }),
        svgElements
      ]
    }
  );
...
function ActionButton({
  ...
  return /* @__PURE__ */ jsxs6(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx15("div", { className: "flex items-center justify-center w-7 h-7", children: icon && /* @__PURE__ */ jsx15(
          Image4,
          {
            width: 20,
            height: 20,
        ...
        /* @__PURE__ */ jsx15("span", { className: `text-[11px] font-medium ${labelColor || "text-text"}`, children: label })
      ]
    }
  );
}
...
function ActionButtons({
  ...
  const prevLoading = useRef4(false);
  useEffect8(() => {
  ...
  if (mode === "review") {
    return /* @__PURE__ */ jsxs7("div", { className: "flex items-center justify-center gap-13 px-6 py-4", children: [
      /* @__PURE__ */ jsx16(ActionButton, { icon: copy_default, label: t.home.qr.copy, onClick: onCopy }),
      /* @__PURE__ */ jsx16(ActionButton, { icon: download_default, label: t.home.qr.download, onClick: onDownload }),
      /* @__PURE__ */ jsx16(ActionButton, { icon: share_default, label: t.home.qr.share, onClick: onShare })
    ] });
  }
  if (mode === "request") {
    return /* @__PURE__ */ jsxs7("div", { className: "flex items-center justify-between px-10 py-4 h-full", children: [
      /* @__PURE__ */ jsx16("span", { className: "w-8.75" }),
      /* @__PURE__ */ jsx16(
        ActionButton,
        {
      ...
      !hideCancel ? /* @__PURE__ */ jsx16("div", { className: "w-8.75", children: /* @__PURE__ */ jsx16(ActionButton, { icon: cancel_default, label: t.home.qr.cancel, onClick: onCancel }) }) : /* @__PURE__ */ jsx16("span", { className: "w-8.75" })
    ] });
  }
  return /* @__PURE__ */ jsxs7("div", { className: "flex items-center justify-center gap-13 px-6 py-4", children: [
    /* @__PURE__ */ jsx16(ActionButton, { icon: addrequest_default, label: t.home.qr.addRequest, onClick: onRequest }),
    /* @__PURE__ */ jsx16(ActionButton, { icon: copy_default, label: t.home.qr.copy, onClick: onCopy }),
    /* @__PURE__ */ jsx16(ActionButton, { icon: download_default, label: t.home.qr.download, onClick: onDownload }),
    /* @__PURE__ */ jsx16(ActionButton, { icon: share_default, label: t.home.qr.share, onClick: onShare })
  ] });
...
import { createContext as createContext7, useContext as useContext7, useState as useState8, useCallback as useCallback5, useRef as useRef5, useMemo as useMemo6 } from "react";
...
var ToastProvider = ({
  ...
  const pauseToast = useCallback5((id) => {
    const timer = timersRef.current.get(id);
    if (timer) {
      clearTimeout(timer);
      timersRef.current.delete(id);
  ...
  const resumeToast = useCallback5(
    (id) => {
      setToasts((prev) => {
...
var useToast = () => {
  const context = useContext7(ToastContext);
  if (!context) {
...
function useTransferPurposes() {
  ...
  const fetchPurposes = useCallback6(async () => {
    setIsFetching(true);
    setError(null);
    try {
...
var Input = ({
  ...
  return /* @__PURE__ */ jsxs8(
    "div",
    {
      ...
      children: [
        label && /* @__PURE__ */ jsxs8("span", { className: "text-[11px] text-[#8D8D8D] font-medium", children: [
          label,
          hideRequired || required && !reviewMode && /* @__PURE__ */ jsx18("span", { className: "text-red-500 ml-0.5", children: "*" }),
          hideRequired || !required && !reviewMode && /* @__PURE__ */ jsxs8("span", { className: "text-[#ADADAD] ml-1", children: [
            "(",
            t.home.qr.optional,
            ")"
          ] })
        ] }),
        /* @__PURE__ */ jsxs8("div", { className: `flex items-center gap-1 ${suffix ? "w-fit" : "w-full"}`, children: [
          reviewMode ? /* @__PURE__ */ jsx18(
            "p",
            {
          ...
          suffix && /* @__PURE__ */ jsx18("span", { className: "text-[13px] font-medium text-text shrink-0", children: suffix })
        ] }),
        description && description,
        hasError && /* @__PURE__ */ jsx18("p", { className: `text-[11px] font-medium ${msgColor}`, children: error.message })
      ]
    }
  );
};
...
var Select = ({
  ...
  const scrollStartLeft = useRef7(0);
  const onMouseDown = (e) => {
  ...
  return /* @__PURE__ */ jsxs9(
    "div",
    {
      className: `flex rounded-[15px] gap-1
             flex-col ${className}`,
      children: [
        label && /* @__PURE__ */ jsxs9("span", { className: "text-[11px] text-[#8D8D8D] font-medium", children: [
          label,
          hideRequired || required && !reviewMode && /* @__PURE__ */ jsx19("span", { className: "text-red-500 ml-0.5", children: "*" }),
          hideRequired || !required && !reviewMode && /* @__PURE__ */ jsxs9("span", { className: "text-[#ADADAD] ml-1", children: [
            "(",
            t.home.qr.optional,
            ")"
          ] })
        ...
        hasError && /* @__PURE__ */ jsx19("p", { className: `text-[11px] font-medium ${msgColor}`, children: error.message })
      ]
    }
  );
};
...
function AccountInfo({
  ...
  const { t } = useTranslation();
  const [internalShowName, setInternalShowName] = useState11(true);
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2 px-1 w-full", children: [
...
function NoteField({ value, onChange, disabled }) {
  ...
  return /* @__PURE__ */ jsxs11("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsx21("div", { className: "absolute left-2 bottom-3 opacity-40", children: /* @__PURE__ */ jsx21(Image6, { src: pin_default, alt: "note", width: 16, height: 16 }) })
  ] });
}
...
function RequestView({
  ...
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx22("div", { className: "w-full flex flex-col h-full overflow-hidden relative", children: /* @__PURE__ */ jsxs12("div", { className: "w-full flex-1 overflow-y-auto pb-20 transition-all duration-300", children: [
    /* @__PURE__ */ jsx22("div", { className: "pt-4 w-full", children: /* @__PURE__ */ jsx22(
      AccountInfo,
      {
        updateField,
        hideRequired: true,
    ...
    mode === "request" && /* @__PURE__ */ jsxs12("div", { className: "w-full flex flex-col gap-2 pt-2", children: [
      /* @__PURE__ */ jsxs12("div", { className: "flex gap-2 w-full", children: [
        /* @__PURE__ */ jsx22(
          Input_default,
          {
            id: "amount-hide",
      ...
      /* @__PURE__ */ jsx22("div", { className: `flex rounded-[15px] p-2
                border border-[#d3d3d35e] bg-[#FFFFFF]
             flex-col gap-1.5 `, children: /* @__PURE__ */ jsx22(
        Select_default,
        {
          required: true,
      ...
      /* @__PURE__ */ jsx22("div", { className: `flex rounded-[15px] p-2
        ...
        Select_default,
        {
          ...
          description: formData.validity !== "Always" && /* @__PURE__ */ jsx22("p", { className: "font-quicksand mt-2 text-center text-[11px] font-normal text-[#1D1D1D] px-1", children: t.home.qr.validityDescription })
        }
      ) })
    ] })
  ] }) });
...
import { useState as useState12, useEffect as useEffect10, useCallback as useCallback9, useRef as useRef8 } from "react";
...
var CountdownTimer = ({ expiryTimestamp, onExpired }) => {
  const { t, language } = useTranslation();
  const onExpiredRef = useRef8(onExpired);
  onExpiredRef.current = onExpired;
  const hasFiredRef = useRef8(false);
  const getRemaining = useCallback9(() => {
    const expiry = new Date(expiryTimestamp).getTime();
    return Math.max(0, Math.floor((expiry - Date.now()) / 1e3));
  }, [expiryTimestamp]);
  const [remainingSeconds, setRemainingSeconds] = useState12(getRemaining);
  useEffect10(() => {
    if (getRemaining() <= 0) {
  ...
  return /* @__PURE__ */ jsxs13("div", { className: "mt-2", children: [
    /* @__PURE__ */ jsx23("p", { className: "text-[11px] text-[#8D8D8D] font-medium", children: t.transfer.deposit.validUntil }),
    /* @__PURE__ */ jsxs13("p", { className: "text-[11px] text-[#8D8D8D] mt-0.5", children: [
      /* @__PURE__ */ jsx23("span", { className: `tracking-widest ${isWarning ? "text-[#FF4D4D]" : "text-[#1D1D1D]"}`, children: formatCountdown(remainingSeconds) }),
      "  ",
      time,
      " \xB7 ",
      date
    ] }),
    /* @__PURE__ */ jsx23("p", { className: `text-[11px] ${isWarning ? "text-[#FF4D4D] " : "text-[#1D1D1D]"} mt-1`, children: t.transfer.deposit.expiryWarning })
  ] });
};
...
function ReadOnlyFields({
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "w-full flex flex-col gap-4 pt-2", children: [
    /* @__PURE__ */ jsxs14("div", { className: "flex gap-2 w-full", children: [
      /* @__PURE__ */ jsx24(
        Input_default,
        {
          hideRequired,
      ...
      formData.reference && /* @__PURE__ */ jsx24(
        Input_default,
        {
          hideRequired,
          reviewMode: true,
    ...
    formData.note && /* @__PURE__ */ jsx24(NoteField, { value: formData.note, disabled: true }),
    !isPermanent && expiresAt ? /* @__PURE__ */ jsx24(CountdownTimer_default, { expiryTimestamp: expiresAt, onExpired: onExpired ?? (() => {
    }) }) : /* @__PURE__ */ jsx24(
      Input_default,
      {
        hideRequired,
        ...
        className: "text-[11px]!",
        containerClassName: "w-1/2",
        description: formData.validity !== "Always" && /* @__PURE__ */ jsx24("p", { className: "font-quicksand mt-2 text-center text-[11px] font-normal text-[#1D1D1D] px-1", children: t.home.qr.validityDescription })
      }
    )
  ] });
}
...
function ReviewView({ formData, purposes, validities, updateField, expiresAt, isPermanent, onExpired }) {
  ...
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx25("div", { className: "w-full flex flex-col h-full overflow-hidden relative", children: /* @__PURE__ */ jsxs15("div", { className: `w-full flex-1 ${isExpired ? "pb-0" : "pb-20"}  overflow-y-auto transition-all duration-300`, children: [
    /* @__PURE__ */ jsx25("div", { className: "pt-4 w-full", children: /* @__PURE__ */ jsx25(
      AccountInfo,
      {
        updateField,
        hideRequired: true,
    ...
    isExpired && /* @__PURE__ */ jsx25("div", { className: "flex items-center justify-center px-6 py-4", children: /* @__PURE__ */ jsx25(
      "button",
      {
        disabled: true,
  ...
  ({ qrValue, purposes, validities, formData }, ref) => {
    return /* @__PURE__ */ jsxs16(
      "div",
      {
        ...
        style: { minWidth: 320 },
        children: [
          /* @__PURE__ */ jsx26("div", { className: "relative w-22 h-7", children: /* @__PURE__ */ jsx26(Image7, { src: title_default, alt: "Title Icon", fill: true, className: "object-contain" }) }),
          /* @__PURE__ */ jsx26("div", { className: "w-62.5 mt-4 h-62.5 flex flex-col items-center justify-center", children: /* @__PURE__ */ jsx26(CustomQRCode, { errorCorrectionLevel: "L", value: qrValue, size: 224 }) }),
          /* @__PURE__ */ jsx26("div", { className: "pt-4 w-full", children: /* @__PURE__ */ jsx26(
            AccountInfo,
            {
              downloadMode: true,
              reviewMode: true,
          ...
          /* @__PURE__ */ jsx26("div", { className: "mt-4 text-center", children: /* @__PURE__ */ jsx26("p", { className: "text-[10px] text-[#8D8D8D]", children: "Powered by Ramaaz Digital Banking" }) })
        ]
      }
    );
  }
...
var CreatePaymentRequest = ({
  ...
  const actions = useActions();
  const downloadRef = useRef9(null);
  ...
  const [mode, setMode] = useState13("address");
  const [qrValue, setQrValue] = useState13(null);
  const [hideQR, setHideQR] = useState13(false);
  const [showPreview, setShowPreview] = useState13(false);
  const [isGenerating, setIsGenerating] = useState13(false);
  const [touched, setTouched] = useState13({});
  const [showName, setShowName] = useState13(true);
  const [requestExpiresAt, setRequestExpiresAt] = useState13(null);
  const [requestIsPermanent, setRequestIsPermanent] = useState13(false);
  const [requestCode, setRequestCode] = useState13(null);
  const [isExpired, setIsExpired] = useState13(false);
  ...
  const generateQrValue = useCallback10(
  ...
  const handleRequest = useCallback10(
    ({
      cU,
      toastMsg = false,
...
Number: ${formData.accountNumber}`
  ...
  const handleExpired = useCallback10(async () => {
    if (requestCode) {
      try {
  ...
  return /* @__PURE__ */ jsx27("div", { className: "flex flex-col items-center w-full max-w-100 mx-auto h-full relative overflow-hidden", children: /* @__PURE__ */ jsxs17("div", { className: "flex-1 w-full flex flex-col pt-2 overflow-hidden", children: [
    /* @__PURE__ */ jsxs17("div", { className: "flex flex-col items-center w-full", children: [
      /* @__PURE__ */ jsx27("div", { className: "relative w-25 h-7", children: /* @__PURE__ */ jsx27(Image8, { src: title_default, alt: "Title Icon", fill: true, className: "object-contain" }) }),
      /* @__PURE__ */ jsxs17("div", { className: "w-65 mt-8 shrink-0 h-65 flex flex-col items-center justify-center gap-2", children: [
        /* @__PURE__ */ jsx27(
          "div",
          {
        ...
        /* @__PURE__ */ jsx27("p", { className: "font-quicksand text-4 opacity-100! mb-2 font-light text-text text-center pt-1", children: isExpired ? "Expired Code ( Time Expired )" : formData.accountNumber })
      ] })
    ] }),
    /* @__PURE__ */ jsx27("div", { className: "flex-1 relative overflow-hidden flex flex-col pt-3", children: mode === "review" ? /* @__PURE__ */ jsx27(
      ReviewView,
      {
        updateField,
        purposes,
    ...
    /* @__PURE__ */ jsx27("div", { className: "absolute bottom-0 left-0 right-0 bg-background border-0 border-[#F2F2F2]", children: !isExpired && /* @__PURE__ */ jsx27(
      ActionButtons,
      {
        isFormValid,
        mode,
    ...
    showPreview && /* @__PURE__ */ jsx27("div", { className: "fixed max-w-100 -left-2499.75 top-0 h-full", "aria-hidden": "true", children: /* @__PURE__ */ jsx27(
...
import { useState as useState17, useEffect as useEffect13, useCallback as useCallback12, useRef as useRef11 } from "react";
...
var ConfirmDialog = ({
  ...
  const [inputValue, setInputValue] = useState14(inputConfig?.defaultValue || "");
  useEffect12(() => {
  ...
  return /* @__PURE__ */ jsx28(AnimatePresence3, { children: open && /* @__PURE__ */ jsx28(
    motion3.div,
    {
      ...
      children: /* @__PURE__ */ jsxs18(
        motion3.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs18("div", { className: "px-6 pt-6 pb-4", children: [
              /* @__PURE__ */ jsx28("h3", { className: "text-lg font-bold text-[#404040] text-center", children: title }),
              /* @__PURE__ */ jsx28("p", { className: "mt-2 text-sm text-gray-500 text-center", children: message }),
              inputConfig && /* @__PURE__ */ jsx28(
                "input",
                {
                  type: "text",
                  value: inputValue,
            ...
            /* @__PURE__ */ jsxs18("div", { className: "flex gap-3 px-6 pb-6", children: [
              /* @__PURE__ */ jsx28(
                "button",
                {
                  type: "button",
...
var DetailRow = ({
  ...
  return /* @__PURE__ */ jsxs19("div", { children: [
    /* @__PURE__ */ jsx29("p", { className: "text-[11px] text-[#8D8D8D] font-medium", children: label }),
    /* @__PURE__ */ jsxs19("div", { className: "flex items-center gap-1.5 mt-0.5", children: [
      icon && /* @__PURE__ */ jsx29("span", { className: "flex-shrink-0", children: icon }),
      /* @__PURE__ */ jsx29(
        "p",
        {
...
var SendButton = ({
  ...
  const { t } = useTranslation();
  if (isExpired) {
    return /* @__PURE__ */ jsx30("div", { className: "flex w-full flex-col items-center py-6", children: /* @__PURE__ */ jsx30(
      "button",
      {
        disabled: true,
  ...
  return /* @__PURE__ */ jsx30("div", { className: "flex w-full flex-col items-center py-6", children: /* @__PURE__ */ jsxs20(
    "button",
    {
      onClick: onSend,
      disabled: !active,
      ...
      children: [
        active ? /* @__PURE__ */ jsx30(Image9, { src: transfer_default, alt: "Send", width: 25, height: 25 }) : /* @__PURE__ */ jsx30(Image9, { src: transferdisabled_default, alt: "Send", width: 25, height: 25 }),
        /* @__PURE__ */ jsx30("span", { className: "text-[13px] font-medium", children: isSending ? t.transfer.deposit.sendingButton : t.transfer.deposit.sendButton })
      ]
    }
  ) });
};
...
import React16, { useRef as useRef10, useState as useState15 } from "react";
  ...
  ({ show, data }, ref) => {
    ...
    return /* @__PURE__ */ jsxs21(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx31("div", { style: { textAlign: "center", marginBottom: "16px" }, children: /* @__PURE__ */ jsx31(
            "p",
            {
              style: {
                fontSize: "20px",
          ...
          /* @__PURE__ */ jsx31("div", { style: { display: "flex", justifyContent: "center", marginBottom: "8px" }, children: /* @__PURE__ */ jsx31(QRCodeDisplay, { value: data.referenceCode, size: 120 }) }),
          /* @__PURE__ */ jsx31(
            "p",
            {
              style: {
          ...
          /* @__PURE__ */ jsx31("div", { style: { borderTop: "1px solid #E8E8E8", margin: "16px 0" } }),
          /* @__PURE__ */ jsxs21("div", { style: { marginBottom: "16px" }, children: [
            /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.senderAccountNumber }),
            /* @__PURE__ */ jsxs21("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: [
          ...
          /* @__PURE__ */ jsx31("div", { style: { borderTop: "1px solid #E8E8E8", margin: "16px 0" } }),
          /* @__PURE__ */ jsxs21("div", { style: { marginBottom: "16px" }, children: [
            /* @__PURE__ */ jsxs21("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: [
          ...
          /* @__PURE__ */ jsx31("div", { style: { borderTop: "1px solid #E8E8E8", margin: "16px 0" } }),
          /* @__PURE__ */ jsxs21("div", { style: { display: "flex", marginBottom: "16px" }, children: [
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.amountSent }),
              /* @__PURE__ */ jsxs21("p", { style: { fontSize: "16px", color: "#1D1D1D", fontWeight: "bold" }, children: [
                data.amount,
                " ",
                data.currency
              ] })
            ...
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.reference }),
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: data.referenceCode })
            ] })
          ] }),
          /* @__PURE__ */ jsxs21("div", { style: { display: "flex", marginBottom: "16px" }, children: [
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.dateTime }),
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: dateTime })
            ] }),
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.type }),
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: t.transfer.receipt.typeValue })
            ] })
          ] }),
          /* @__PURE__ */ jsxs21("div", { style: { display: "flex", marginBottom: "16px" }, children: [
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.purpose }),
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: data.purposeLabel })
            ] }),
            /* @__PURE__ */ jsxs21("div", { style: { flex: 1 }, children: [
              /* @__PURE__ */ jsx31("p", { style: { fontSize: "11px", color: "#8D8D8D", marginBottom: "4px" }, children: t.transfer.receipt.status }),
              /* @__PURE__ */ jsxs21("p", { style: { fontSize: "13px", color: "#1D1D1D", fontWeight: "500" }, children: [
                displayStatus,
                " \u2713"
              ] })
...
function QRCodeDisplay({ value, size, bg }) {
  return /* @__PURE__ */ jsx32(CustomQRCode, { value, size, errorCorrectionLevel: "L", bg });
}
var SuccessReceipt = ({ data, onClose }) => {
  const { toast } = useToast();
  const { t, language, tr: tr2 } = useTranslation();
  const downloadRef = useRef10(null);
  ...
  return /* @__PURE__ */ jsxs22("div", { className: "flex flex-col relative bg-[#F4FFFA] h-full items-center px-6 pb-6 w-full overflow-y-auto", children: [
    /* @__PURE__ */ jsx32("div", { className: "mt-4 mb-3", children: /* @__PURE__ */ jsx32(Image10, { src: transferdone_default, alt: "Transfer Done", width: 48, height: 48 }) }),
    /* @__PURE__ */ jsx32("h2", { className: "text-[13px] font-bold text-[#1D1D1D] tracking-widest text-center mb-4 uppercase", children: t.transfer.receipt.moneySentSuccess }),
    /* @__PURE__ */ jsx32("div", { className: "mb-2", children: /* @__PURE__ */ jsx32(CustomQRCode, { value: data.referenceCode, bg: "#F4FFFA", size: 140 }) }),
    /* @__PURE__ */ jsx32("p", { className: "text-[13px] text-[#1D1D1D] font-medium mb-6", children: data.referenceCode }),
    /* @__PURE__ */ jsxs22("div", { className: "max-w-md space-y-4", children: [
      /* @__PURE__ */ jsx32(
        DetailRow_default,
        {
      ...
      /* @__PURE__ */ jsxs22("div", { children: [
        /* @__PURE__ */ jsxs22("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsx32("p", { className: "text-[11px] text-[#8D8D8D] font-medium", children: t.transfer.receipt.recipientAccountNumber }),
          data.inputMethod === "QR" && /* @__PURE__ */ jsx32(
            Image10,
            {
        ...
        /* @__PURE__ */ jsxs22("p", { className: "text-[13px] text-[#1D1D1D] font-medium", children: [
          data.recipientAccountNumber,
          " ",
          data.recipientMaskedName
        ] })
      ] }),
      /* @__PURE__ */ jsxs22("div", { className: "grid grid-cols-2 gap-y-4 gap-x-12", children: [
        /* @__PURE__ */ jsx32(
          DetailRow_default,
          {
        ...
        /* @__PURE__ */ jsx32(DetailRow_default, { label: t.transfer.receipt.dateTime, value: dateTime }),
        /* @__PURE__ */ jsx32(
          DetailRow_default,
          {
        ...
        /* @__PURE__ */ jsx32(DetailRow_default, { label: t.transfer.receipt.purpose, value: data.purposeLabel }),
        /* @__PURE__ */ jsxs22("div", { children: [
          /* @__PURE__ */ jsx32("p", { className: "text-[11px] text-[#8D8D8D] font-medium", children: t.transfer.receipt.status }),
          /* @__PURE__ */ jsxs22("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx32("span", { className: "text-[13px] text-[#1D1D1D] font-medium", children: displayStatus }),
            /* @__PURE__ */ jsx32(Image10, { src: success_default, alt: "Success", width: 16, height: 16 })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx32("div", { className: "mt-6 mb-4", children: /* @__PURE__ */ jsx32("p", { className: "text-[18px] w-20 font-quicksand font-bold text-[#1D1D1D] tracking-wider", children: /* @__PURE__ */ jsx32(Image10, { alt: "trydos", width: 80, height: 25, src: trydos_default }) }) }),
    /* @__PURE__ */ jsxs22("div", { className: "flex bg-[#F4FFFA] absolute bottom-0 max-w-100 items-center justify-around w-full m-4 pt-4 border-t border-gray-100", children: [
      /* @__PURE__ */ jsxs22(
        "button",
        {
          onClick: onClose,
          ...
          children: [
            /* @__PURE__ */ jsx32(Image10, { src: done_default, alt: "Done", width: 24, height: 24 }),
            /* @__PURE__ */ jsx32("span", { className: "text-[11px] font-medium", children: t.transfer.receipt.done })
          ]
        }
      ),
      /* @__PURE__ */ jsxs22(
        "button",
        {
          ...
          className: "flex flex-col cursor-pointer items-center gap-1 text-[#1D1D1D]",
          children: [
            /* @__PURE__ */ jsx32(Image10, { src: download_default, alt: "Download", width: 24, height: 24 }),
            /* @__PURE__ */ jsx32("span", { className: "text-[11px] font-medium", children: t.transfer.receipt.download })
          ]
        }
      ),
      /* @__PURE__ */ jsxs22(
        "button",
        {
          ...
          className: "flex flex-col cursor-pointer items-center gap-1 text-[#1D1D1D]",
          children: [
            /* @__PURE__ */ jsx32(Image10, { src: share_default, alt: "Share", width: 24, height: 24 }),
            /* @__PURE__ */ jsx32("span", { className: "text-[11px] font-medium", children: t.transfer.receipt.share })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsx32(DownloadView_default2, { ref: downloadRef, show: showPreview, data })
  ] });
};
...
var SenderCard = () => {
  ...
  const [isRefreshing, setIsRefreshing] = useState16(false);
  ...
  return /* @__PURE__ */ jsxs23("div", { className: "bg-[#3C3C3C] rounded-2xl h-30 p-4 max-w-92.5 relative", children: [
    /* @__PURE__ */ jsx33(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx33(Image11, { src: refresh_default, alt: "Refresh", width: 20, height: 20 })
      }
    ),
    /* @__PURE__ */ jsx33(Image11, { src: dollar_default, alt: "Currency", width: 20, height: 20 }),
    /* @__PURE__ */ jsx33("p", { className: "text-white text-[11px] font-light font-quicksand mt-1", children: t.transfer.sender.label }),
    /* @__PURE__ */ jsxs23("p", { className: "text-[#FCFCFC] font-light font-quicksand text-[13px] mt-0.5", children: [
      accountType,
      " | ",
      accountNumber,
      " | ",
    ...
    /* @__PURE__ */ jsxs23("div", { className: "flex items-end gap-2 mt-2", children: [
      /* @__PURE__ */ jsx33("span", { className: "text-white text-[25px] font-medium font-quicksand leading-none", children: isRefreshing ? /* @__PURE__ */ jsx33(Loader2, { className: "w-12 h-6.5 text-white animate-spin" }) : balanceHidden ? "\u2022\u2022\u2022\u2022" : available.toLocaleString(language) }),
      /* @__PURE__ */ jsxs23("div", { className: "flex items-center gap-1.5 pb-1", children: [
        /* @__PURE__ */ jsxs23("span", { className: "text-white font-light font-quicksand text-[9px]", children: [
          currencySymbol,
          " | ",
          currencyName
        ] }),
        /* @__PURE__ */ jsx33(
          "button",
          {
            ...
            children: balanceHidden ? /* @__PURE__ */ jsx33(Image11, { src: eye_white_default, alt: "Show", width: 14, height: 14 }) : /* @__PURE__ */ jsx33(Image11, { src: eye_white_default, alt: "Hide", width: 14, height: 14 })
          }
        )
      ] })
    ] })
...
var PaymentRequestReview = ({
  ...
  const apiRef = useRef11(api);
  apiRef.current = api;
  const encryptRef = useRef11(encrypt);
  encryptRef.current = encrypt;
  const decryptRef = useRef11(decrypt);
  decryptRef.current = decrypt;
  const toastRef = useRef11(toast);
  toastRef.current = toast;
  const onBackRef = useRef11(onBack);
  onBackRef.current = onBack;
  const [loading, setLoading] = useState17(true);
  const [fetchError, setFetchError] = useState17(null);
  const [data, setData] = useState17(null);
  const [requestId, setRequestId] = useState17("");
  const [qrValue, setQrValue] = useState17(null);
  const captureRef = useRef11(null);
  const [showPreview, setShowPreview] = useState17(false);
  const [isExpired, setIsExpired] = useState17(false);
  const [isSending, setIsSending] = useState17(false);
  const [isCancelling, setIsCancelling] = useState17(false);
  const [receiptData, setReceiptData] = useState17(null);
  const [sendError, setSendError] = useState17(null);
  const [showCancelDialog, setShowCancelDialog] = useState17(false);
  const [showCancelInput, setShowCancelInput] = useState17(false);
  const [cancelReason, setCancelReason] = useState17("");
  ...
  const handleExpired = useCallback12(async () => {
    try {
      let code = null;
      if (directRequestCode) {
        code = directRequestCode;
  ...
  if (loading) {
    return /* @__PURE__ */ jsx34("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxs24("div", { className: "flex flex-col items-center gap-3", children: [
      /* @__PURE__ */ jsx34("div", { className: "w-8 h-8 border-2 border-[#388CFF] border-t-transparent rounded-full animate-spin" }),
      /* @__PURE__ */ jsxs24("p", { className: "text-[13px] text-[#8D8D8D]", children: [
  ...
  if (fetchError || !data) {
    return /* @__PURE__ */ jsx34("div", { className: "w-full h-full flex items-center justify-center", children: /* @__PURE__ */ jsxs24("div", { className: "flex flex-col items-center gap-3 px-6 text-center", children: [
      /* @__PURE__ */ jsx34("p", { className: "text-[13px] text-[#FF4D4D]", children: fetchError || "Failed to load request" }),
      /* @__PURE__ */ jsx34(
        "button",
        {
      ...
      /* @__PURE__ */ jsx34("button", { onClick: onBack, className: "text-[13px] text-[#8D8D8D] mt-1", children: "Go back" })
    ] }) });
  }
  if (receiptData) {
    return /* @__PURE__ */ jsx34(SuccessReceipt_default, { data: receiptData, onClose: onDone });
  }
  if (isRequesterMode && data.status === "FULFILLED") {
    ...
    return /* @__PURE__ */ jsx34(SuccessReceipt_default, { data: fulfilledReceipt, onClose: onDone });
  }
  if (isRequesterMode) {
    const isActive = data.status === "ACTIVE" && !isExpired;
    return /* @__PURE__ */ jsxs24("div", { className: "flex flex-col items-center w-full h-full relative overflow-hidden", children: [
      /* @__PURE__ */ jsxs24("div", { className: `flex-1 w-full flex flex-col ${isRequesterMode ? " pb-0" : " pb-24"} pt-2 overflow-y-auto max-w-100`, children: [
        /* @__PURE__ */ jsxs24("div", { className: "flex flex-col items-center w-full", children: [
          /* @__PURE__ */ jsx34("div", { className: "relative w-25 h-7", children: /* @__PURE__ */ jsx34(
            Image12,
            {
              src: title_default,
              alt: "Title Icon",
          ...
          /* @__PURE__ */ jsxs24("div", { className: "w-62.5 mt-3 shrink-0 h-62.5 flex flex-col items-center justify-center gap-2", children: [
            /* @__PURE__ */ jsx34("div", { ref: captureRef, className: isRequesterDead ? "opacity-10" : "", children: /* @__PURE__ */ jsx34(
              CustomQRCode,
              {
                errorCorrectionLevel: "L",
                value: qrValue || "",
            ...
            /* @__PURE__ */ jsx34("p", { className: "font-quicksand text-4 font-light text-text text-center pt-1", children: isRequesterDead ? "Expired Code ( Time Expired )" : data.requesterAccountNumber })
          ] })
        ] }),
        /* @__PURE__ */ jsxs24("div", { className: "px-2 mt-2 space-y-0 bg-transparent", children: [
          /* @__PURE__ */ jsx34(
            Input_default,
            {
          ...
          /* @__PURE__ */ jsxs24("div", { className: "flex gap-2 w-full", children: [
            /* @__PURE__ */ jsx34(
              Input_default,
              {
                hideRequired: true,
          ...
          /* @__PURE__ */ jsxs24("div", { className: "flex gap-2 w-full", children: [
            data.purpose?.name && /* @__PURE__ */ jsx34(
              Input_default,
              {
                hideRequired: true,
                reviewMode: true,
          ...
          /* @__PURE__ */ jsx34("div", { className: "flex gap-2 w-full", children: data.note && /* @__PURE__ */ jsx34(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
          ...
          /* @__PURE__ */ jsx34("div", { className: "flex gap-2 w-full px-2", children: data.isPermanent ? /* @__PURE__ */ jsx34(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
          ...
          isRequesterDead && /* @__PURE__ */ jsx34("div", { className: "flex w-full flex-col items-center py-4", children: /* @__PURE__ */ jsx34(
            "button",
            {
              disabled: true,
      ...
      isActive && /* @__PURE__ */ jsx34("div", { className: "absolute bottom-0 left-0 right-0 bg-background border-0 border-[#F2F2F2]", children: /* @__PURE__ */ jsxs24("div", { className: "flex items-center justify-center gap-13 px-6 py-4", children: [
        /* @__PURE__ */ jsx34(
          ActionButton,
          {
            icon: copy_default,
  ...
  return /* @__PURE__ */ jsx34("div", { className: "w-full h-full overflow-y-auto relative flex flex-col", children: /* @__PURE__ */ jsxs24("div", { className: "max-w-93.75 mx-auto relative w-full flex flex-col flex-1", children: [
    /* @__PURE__ */ jsxs24("div", { className: "flex flex-col items-center mb-4 pt-2", children: [
      /* @__PURE__ */ jsx34("div", { className: "mb-3", children: /* @__PURE__ */ jsx34(Image12, { src: sendT_default, alt: "Transfer", width: 40, height: 40 }) }),
      /* @__PURE__ */ jsx34("h2", { className: "font-quicksand text-[13px] font-medium tracking-widest text-[#1D1D1D] uppercase", children: t.transfer.deposit.title })
    ] }),
    /* @__PURE__ */ jsx34(SenderCard_default, {}),
    /* @__PURE__ */ jsx34("p", { className: "text-[13px] text-[#1D1D1D] font-medium text-center mt-4 mb-2", children: t.transfer.sendTo }),
    /* @__PURE__ */ jsxs24("div", { className: "overflow-auto pb-40 px-2 space-y-3", children: [
      /* @__PURE__ */ jsx34(
        DetailRow_default,
        {
      ...
      data.reference && /* @__PURE__ */ jsx34(DetailRow_default, { label: t.transfer.deposit.referenceId, value: data.reference }),
      data.note && /* @__PURE__ */ jsx34(DetailRow_default, { label: "Note", value: data.note }),
      !data.isPermanent && data.expiresAt && /* @__PURE__ */ jsx34(
        CountdownTimer_default,
        {
          expiryTimestamp: data.expiresAt,
          onExpired: handleExpired
      ...
      sendError && /* @__PURE__ */ jsx34("div", { className: "bg-[#FFF0F0] border border-[#FF4D4D]/20 rounded-lg p-3 mt-2", children: /* @__PURE__ */ jsx34("p", { className: "text-[12px] text-[#FF4D4D]", children: sendError }) }),
      showCancelInput && /* @__PURE__ */ jsxs24("div", { className: "mt-3 flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx34(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsx34("div", { className: "absolute bottom-0 w-full bg-white", children: /* @__PURE__ */ jsx34("div", { className: "flex flex-col gap-2 px-4", children: /* @__PURE__ */ jsx34(
      SendButton_default,
      {
...
var TransactionDetails = ({ ledger, onClose }) => {
  ...
  return /* @__PURE__ */ jsxs25("div", { className: "flex flex-col items-center w-full h-full relative overflow-hidden", children: [
    /* @__PURE__ */ jsxs25("div", { className: "flex-1 w-full flex flex-col pt-2 overflow-y-auto pb-20", children: [
      /* @__PURE__ */ jsx35("div", { className: "flex flex-col items-center w-full mb-4", children: /* @__PURE__ */ jsx35("div", { className: "relative w-25 h-7", children: /* @__PURE__ */ jsx35(Image13, { src: title_default, alt: "Title Icon", fill: true, className: "object-contain" }) }) }),
      /* @__PURE__ */ jsx35(
        "div",
        {
      ...
      /* @__PURE__ */ jsxs25("div", { className: "px-2 space-y-0", children: [
        ledger.senderAccount && /* @__PURE__ */ jsx35(
          Input_default,
          {
            hideRequired: true,
            reviewMode: true,
        ...
        /* @__PURE__ */ jsxs25("div", { className: "flex gap-2 w-full", children: [
          /* @__PURE__ */ jsx35(
            Input_default,
            {
              hideRequired: true,
          ...
          ledger.referenceId && /* @__PURE__ */ jsx35(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
        ...
        ledger.metadata?.purposeName && /* @__PURE__ */ jsx35(
          Input_default,
          {
            hideRequired: true,
            reviewMode: true,
        ...
        (ledger.feeAmount > 0 || ledger.taxAmount > 0) && /* @__PURE__ */ jsxs25("div", { className: "flex gap-2 w-full", children: [
          ledger.feeAmount > 0 && /* @__PURE__ */ jsx35(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
          ...
          ledger.taxAmount > 0 && /* @__PURE__ */ jsx35(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
        ...
        (ledger.note || ledger.metadata?.note) && /* @__PURE__ */ jsx35(
          Input_default,
          {
            hideRequired: true,
            reviewMode: true,
        ...
        ledger.description && /* @__PURE__ */ jsx35(
          Input_default,
          {
            hideRequired: true,
            reviewMode: true,
    ...
    /* @__PURE__ */ jsx35("div", { className: "absolute bottom-0 left-0 right-0 bg-background border-0 border-[#F2F2F2]", children: /* @__PURE__ */ jsx35("div", { className: "flex items-center justify-center py-4 px-4", children: /* @__PURE__ */ jsxs25(
      "button",
      {
        onClick: onClose,
        className: "flex flex-col cursor-pointer items-center gap-1 text-[#1D1D1D]",
        children: [
          /* @__PURE__ */ jsx35(Image13, { src: done_default, alt: "Done", width: 24, height: 24 }),
          /* @__PURE__ */ jsx35("span", { className: "text-[11px] font-medium", children: t.transfer.receipt.done })
        ]
      }
    ) }) })
  ] });
...
import { useEffect as useEffect14, useCallback as useCallback13, useRef as useRef12, useState as useState18 } from "react";
import { motion as motion4, AnimatePresence as AnimatePresence4, useDragControls } from "framer-motion";
...
var BottomSheet = ({
  ...
  const [sheetHeight, setSheetHeight] = useState18(0);
  ...
  const handleBackdropClick = useCallback13((e) => {
    if (e.target === e.currentTarget) {
      setIsVisible(false);
    }
  }, []);
  ...
  return /* @__PURE__ */ jsx36(AnimatePresence4, { mode: "wait", onExitComplete: onClose, children: isVisible && // BACKDROP OVERLAY
  /* @__PURE__ */ jsx36(
    motion4.div,
    {
...
var Home = () => {
  ...
  const [showDeposit, setShowDeposit] = useState19(false);
  const [activeRequestCode, setActiveRequestCode] = useState19(null);
  const [activeTransaction, setActiveTransaction] = useState19(null);
  const handlePaymentRequestTap = useCallback14((requestCode) => {
    setActiveRequestCode(requestCode);
  }, []);
  const handlePaymentRequestClose = useCallback14(() => {
    setActiveRequestCode(null);
  }, []);
  const handleTransactionTap = useCallback14((ledger) => {
    setActiveTransaction(ledger);
  }, []);
  const handleTransactionClose = useCallback14(() => {
    setActiveTransaction(null);
  }, []);
  return /* @__PURE__ */ jsxs27("div", { className: "flex flex-col items-start justify-start w-full h-full overflow-hidden", children: [
    /* @__PURE__ */ jsx37("div", { className: "w-full shrink-0", children: /* @__PURE__ */ jsx37(nav_default, { activeAssetSymbol }) }),
    /* @__PURE__ */ jsx37("div", { className: "w-full shrink-0 ", children: /* @__PURE__ */ jsx37(
      balance_default,
      {
        setActiveAssetType,
        activeAssetType,
    ...
    /* @__PURE__ */ jsx37(BottomSheet_default, { height: "95dvh", open: showDeposit, onClose: () => setShowDeposit(false), children: /* @__PURE__ */ jsx37(
    ...
    /* @__PURE__ */ jsx37(
      BottomSheet_default,
      {
        ...
        children: activeRequestCode && /* @__PURE__ */ jsx37(
    ...
    /* @__PURE__ */ jsx37(
      BottomSheet_default,
      {
        ...
        children: activeTransaction && /* @__PURE__ */ jsx37(
...
function AddressesPage() {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx39("div", { className: "w-full h-full flex items-center justify-center", children: t.pages.addresses });
}
...
import { useState as useState20, useRef as useRef13, useEffect as useEffect15 } from "react";
        ...
        `,
            ...
            children: [
              /* @__PURE__ */ jsxs28("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx40("span", { className: "text-xl leading-none", children: /* @__PURE__ */ jsx40(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsx40("span", { className: "text-sm font-medium text-gray-800", children: t.languageSelector[selected.labelKey] }),
                /* @__PURE__ */ jsx40("span", { className: "text-xs text-gray-400 font-normal", children: selected.code.toUpperCase() })
              ] }),
              /* @__PURE__ */ jsx40(
                ChevronDown,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs28("div", { className: "flex items-center gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxs28("div", { className: "flex flex-col items-start", children: [
                        ...
                        /* @__PURE__ */ jsx40("span", { className: "text-[11px] text-gray-400", children: lang.nativeName })
                      ] })
                    ] }),
                    isSelected && /* @__PURE__ */ jsx40("div", { className: "w-5 h-5 rounded-full bg-[#3066CC] flex items-center justify-center", children: /* @__PURE__ */ jsx40(Check, { className: "w-3 h-3 text-white", strokeWidth: 3 }) })
                  ]
                },
                lang.code
              );
...
// src/components/profile/ProfileContent.tsx
import Skeleton3 from "react-loading-skeleton";
import { jsx as jsx41, jsxs as jsxs29 } from "react/jsx-runtime";
var ProfileContent = () => {
  const { userData, removeAuthCookies, isLoading } = useAuth();
  const router = useUniversalRouter();
  const { t, language } = useTranslation();
  const [showLogoutDialog, setShowLogoutDialog] = useState21(false);
  const [imgError, setImgError] = useState21(false);
  const handleLogout = async () => {
    await removeAuthCookies();
    router.push("/auth");
  };
  if (isLoading) {
    return /* @__PURE__ */ jsxs29("div", { className: "flex flex-col w-full h-full overflow-y-auto bg-white p-4 gap-4", children: [
      /* @__PURE__ */ jsxs29("div", { className: "flex flex-col items-center gap-3 bg-gray-50 rounded-[15px] p-6", children: [
        /* @__PURE__ */ jsx41(Skeleton3, { circle: true, width: 64, height: 64 }),
        /* @__PURE__ */ jsx41(Skeleton3, { width: 140, height: 20, borderRadius: 8 }),
        /* @__PURE__ */ jsx41(Skeleton3, { width: 80, height: 14, borderRadius: 8 })
      ] }),
      /* @__PURE__ */ jsx41(Skeleton3, { width: 160, height: 18, borderRadius: 8 }),
      [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx41(Skeleton3, { height: 56, borderRadius: 15 }, i)),
      /* @__PURE__ */ jsx41(Skeleton3, { width: 160, height: 18, borderRadius: 8 }),
      [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx41(Skeleton3, { height: 56, borderRadius: 15 }, `acc-${i}`))
    ] });
  }
  if (!userData) {
    return /* @__PURE__ */ jsx41("div", { className: "w-full h-full flex items-center justify-center text-gray-500", children: t.profile.noUserData });
  }
  ...
  const renderInfoItem = (icon, label, value, badge) => /* @__PURE__ */ jsxs29("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-[15px]", children: [
    /* @__PURE__ */ jsx41("div", { className: "w-5 h-5 text-[#3066CC] mt-1 shrink-0", children: icon }),
    /* @__PURE__ */ jsxs29("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsx41("p", { className: "text-xs text-gray-500", children: label }),
      /* @__PURE__ */ jsxs29("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx41("p", { className: "text-sm font-medium text-gray-800 truncate", children: value || /* @__PURE__ */ jsx41("span", { className: "text-gray-400 italic", children: t.profile.notProvided }) }),
        badge
      ] })
    ] })
  ] });
  const verifiedBadge = /* @__PURE__ */ jsx41("span", { className: "text-[#10b981] text-xs font-medium shrink-0", children: t.profile.verified });
  return /* @__PURE__ */ jsxs29("div", { className: "flex flex-col w-full h-full overflow-y-auto bg-white", children: [
    /* @__PURE__ */ jsxs29("div", { className: "flex-1 p-4 space-y-4 max-w-2xl mx-auto w-full", children: [
      /* @__PURE__ */ jsxs29("div", { className: "flex flex-col items-center gap-3 bg-gray-50 rounded-[15px] p-6", children: [
        user.profilePictureURL && !imgError ? /* @__PURE__ */ jsx41("div", { className: "relative w-16 h-16 rounded-full ring-2 ring-[#3066CC] ring-offset-2 overflow-hidden", children: /* @__PURE__ */ jsx41(
          Image14,
          {
        ...
        ) }) : /* @__PURE__ */ jsxs29("div", { className: "w-16 h-16 bg-[#3066CC] rounded-full ring-2 ring-[#3066CC] ring-offset-2 flex items-center justify-center text-xl font-bold text-white", children: [
          user.firstName?.[0] || t.profile.fallbackInitial,
          user.lastName?.[0]
        ] }),
        /* @__PURE__ */ jsxs29("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxs29("h1", { className: "text-lg font-bold text-[#404040] truncate max-w-62.5", children: [
            user.firstName,
            " ",
            user.lastName
          ] }),
          /* @__PURE__ */ jsx41("p", { className: "text-xs text-gray-500 mt-0.5", children: user.userType })
        ] })
      ] }),
      /* @__PURE__ */ jsxs29("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx41("h2", { className: "text-lg font-bold text-[#404040]", children: t.profile.personalInfo }),
        renderInfoItem(
          /* @__PURE__ */ jsx41(Mail, { className: "w-5 h-5" }),
          t.profile.email,
          user.email,
          user.isEmailVerified ? verifiedBadge : void 0
        ),
        renderInfoItem(
          /* @__PURE__ */ jsx41(Phone, { className: "w-5 h-5" }),
          t.profile.phoneNumber,
          user.phoneNumber,
          user.isPhoneVerified ? verifiedBadge : void 0
        ),
        renderInfoItem(
          /* @__PURE__ */ jsx41(User, { className: "w-5 h-5" }),
          t.profile.firstName,
          user.firstName
        ),
        renderInfoItem(
      ...
      user.address && /* @__PURE__ */ jsxs29("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx41("h2", { className: "text-lg font-bold text-[#404040]", children: t.profile.addressSection }),
        renderInfoItem(
          /* @__PURE__ */ jsx41(MapPin, { className: "w-5 h-5" }),
          t.profile.country,
      ...
      /* @__PURE__ */ jsxs29("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx41("h2", { className: "text-lg font-bold text-[#404040]", children: t.profile.accountInfo }),
        /* @__PURE__ */ jsxs29("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-[15px]", children: [
          /* @__PURE__ */ jsx41(Shield, { className: "w-5 h-5 text-[#3066CC] mt-1 shrink-0" }),
          /* @__PURE__ */ jsxs29("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx41("p", { className: "text-xs text-gray-500", children: t.profile.accountStatus }),
            /* @__PURE__ */ jsx41(
              "p",
              {
            ...
            user.isBlocked && user.blockReason && /* @__PURE__ */ jsx41("p", { className: "text-xs text-[#ef4444] mt-1", children: user.blockReason })
          ] })
        ] }),
        /* @__PURE__ */ jsxs29("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-[15px]", children: [
          /* @__PURE__ */ jsx41(Eye, { className: "w-5 h-5 text-[#3066CC] mt-1 shrink-0" }),
          /* @__PURE__ */ jsxs29("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx41("p", { className: "text-xs text-gray-500", children: t.profile.twoFactor }),
            /* @__PURE__ */ jsx41(
              "p",
              {
        ...
        renderInfoItem(
          /* @__PURE__ */ jsx41(Calendar, { className: "w-5 h-5" }),
          t.profile.memberSince,
          new Date(user.createdAt).toLocaleDateString()
        ),
        /* @__PURE__ */ jsxs29("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-[15px]", children: [
          /* @__PURE__ */ jsx41(Globe, { className: "w-5 h-5 text-[#3066CC] mt-1 shrink-0" }),
          /* @__PURE__ */ jsx41("p", { className: "text-xs text-gray-500 mt-1", children: t.languageSelector.label }),
          /* @__PURE__ */ jsx41("div", { className: "flex justify-end flex-row w-full", children: /* @__PURE__ */ jsx41(LanguageSelector, {}) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs29(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx41(LogOut, { className: "w-5 h-5" }),
            t.profile.logout
          ]
        }
      )
...
function SettingsPage() {
  return /* @__PURE__ */ jsx42(ProfileContent_default, {});
}

// src/components/transactions/index.tsx
import { useState as useState22, useCallback as useCallback15 } from "react";
...
var Transactions = () => {
  ...
  const [activeRequestCode, setActiveRequestCode] = useState22(null);
  const [activeTransaction, setActiveTransaction] = useState22(null);
  const handlePaymentRequestTap = useCallback15((requestCode) => {
    setActiveRequestCode(requestCode);
  }, []);
  const handleTransactionTap = useCallback15((ledger) => {
    setActiveTransaction(ledger);
  }, []);
  const handleTransactionClose = useCallback15(() => {
    setActiveTransaction(null);
  }, []);
  return /* @__PURE__ */ jsxs30("div", { className: "flex mt-4 flex-col items-start justify-start w-full h-full overflow-hidden", children: [
    /* @__PURE__ */ jsx43(
      transactions_default,
      {
        transactions,
    ...
    /* @__PURE__ */ jsx43(
      BottomSheet_default,
      {
        ...
        open: !!activeTransaction,
        onClose: handleTransactionClose,
        children: activeTransaction && /* @__PURE__ */ jsx43(
          TransactionDetails_default,
          {
            ledger: activeTransaction,
            onClose: handleTransactionClose
...
function TransactionsPage() {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsx44(Transactions, {});
}
...
var HomeIcon = ({ active = false, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs31("svg", { xmlns: "http://www.w3.org/2000/svg", width: "25", height: "25", viewBox: "0 0 25 25", ...props, children: [
    /* @__PURE__ */ jsx45("defs", { children: /* @__PURE__ */ jsx45("clipPath", { id: "clip-path-home", children: /* @__PURE__ */ jsx45("rect", { width: "25", height: "25", transform: "translate(0 0.382)", fill: fillBgColor }) }) }),
    /* @__PURE__ */ jsx45("g", { transform: "translate(-93 -533.407)", children: /* @__PURE__ */ jsx45("g", { transform: "translate(93 533.025)", children: /* @__PURE__ */ jsx45("g", { clipPath: "url(#clip-path-home)", children: /* @__PURE__ */ jsxs31("g", { transform: "translate(-0.102 3.068)", children: [
      /* @__PURE__ */ jsx45("circle", { cx: "0.953", cy: "0.953", r: "0.953", transform: "translate(19.86 8.757)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" }),
      /* @__PURE__ */ jsx45("path", { d: "M42.081,21.2H37.324a2.868,2.868,0,0,0,0,5.737h4.757a1.166,1.166,0,0,0,1.165-1.165V22.367A1.166,1.166,0,0,0,42.081,21.2Zm-3.23,4.457A1.589,1.589,0,1,1,40.44,24.07,1.591,1.591,0,0,1,38.851,25.659Z", transform: "translate(-18.038 -14.36)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" }),
      /* @__PURE__ */ jsx45("path", { d: "M17.674,17.342a3.508,3.508,0,0,1,3.5-3.5h4V9.644a2.015,2.015,0,0,0-2.012-2.012H3.9A2.015,2.015,0,0,0,1.891,9.644v4.414H4.372L5.2,12.124a.318.318,0,0,1,.293-.193H7.613a1.59,1.59,0,1,1,0,.636H5.7L4.875,14.5a.318.318,0,0,1-.293.193H1.891v2.33h5.72a1.589,1.589,0,1,1,0,.636H1.891v2.33H4.583a.318.318,0,0,1,.293.193L5.7,22.117H7.61a1.588,1.588,0,1,1,0,.636H5.489a.318.318,0,0,1-.293-.193l-.824-1.934H1.891v4.414A2.015,2.015,0,0,0,3.9,27.052H23.161a2.015,2.015,0,0,0,2.012-2.012V20.845h-4A3.508,3.508,0,0,1,17.674,17.342Z", transform: "translate(-1.891 -7.632)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" }),
      /* @__PURE__ */ jsx45("circle", { cx: "0.953", cy: "0.953", r: "0.953", transform: "translate(6.324 13.841)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" }),
      /* @__PURE__ */ jsx45("circle", { cx: "0.953", cy: "0.953", r: "0.953", transform: "translate(6.324 3.673)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" }),
      /* @__PURE__ */ jsx45("circle", { cx: "0.953", cy: "0.953", r: "0.953", transform: "translate(6.324 8.757)", fill: fillColor, stroke: strokeColor, strokeWidth: "0.5" })
    ] }) }) }) })
  ] });
};
var TransactionIcon = ({ active = false, ...props }) => {
  ...
  return /* @__PURE__ */ jsxs31("svg", { xmlns: "http://www.w3.org/2000/svg", width: "25", height: "25", viewBox: "0 0 25 25", ...props, children: [
    /* @__PURE__ */ jsx45("circle", { cx: "12.5", cy: "12.5", r: "12.5", fill: bgColor }),
    /* @__PURE__ */ jsxs31("g", { id: "Group_12972", "data-name": "Group 12972", transform: "translate(-333 -261)", children: [
      /* @__PURE__ */ jsx45("path", { id: "Path_22466_-_Outline", "data-name": "Path 22466 - Outline", d: "M12.5.625A11.875,11.875,0,1,0,24.375,12.5,11.888,11.888,0,0,0,12.5.625M12.5,0A12.5,12.5,0,1,1,0,12.5,12.5,12.5,0,0,1,12.5,0Z", transform: "translate(333 261)", fill: fgColor }),
      /* @__PURE__ */ jsx45("path", { id: "arrow-button", d: "M12.261,6.172a.588.588,0,0,1,.832,0l4.159,4.159a.588.588,0,0,1-.832.832L13.265,8.008v9.16a.588.588,0,0,1-1.176,0V8.008L8.933,11.163a.588.588,0,0,1-.832-.832Z", transform: "translate(336.994 261.621)", fill: fgColor, fillRule: "evenodd" }),
      /* @__PURE__ */ jsx45("path", { id: "arrow-button-2", "data-name": "arrow-button", d: "M12.261,17.584a.588.588,0,0,0,.832,0l4.159-4.159a.588.588,0,0,0-.832-.832l-3.155,3.155V6.588a.588.588,0,0,0-1.176,0v9.16L8.933,12.593a.588.588,0,1,0-.832.832Z", transform: "translate(328.658 261.621)", fill: fgColor, fillRule: "evenodd" })
    ] })
  ] });
};
var AddressIcon = ({ active = false, ...props }) => {
  ...
  const bgColor = active ? "#404040" : "#F4F5F5";
  return /* @__PURE__ */ jsxs31("svg", { xmlns: "http://www.w3.org/2000/svg", width: "25", height: "25", viewBox: "0 0 25 25", ...props, children: [
    /* @__PURE__ */ jsx45("rect", { width: "25", height: "25", rx: "5", fill: bgColor }),
    /* @__PURE__ */ jsx45("g", { id: "Mask_Group_613", "data-name": "Mask Group 613", children: /* @__PURE__ */ jsx45("path", { id: "wallet-2", d: "M24.166,13.827V8.75a1.231,1.231,0,0,0-.417-.922V4.584a1.25,1.25,0,0,0-1.25-1.25H19.676a5.369,5.369,0,0,0-6.524-1.576A5.409,5.409,0,0,0,4.167,3.334H2.5A2.508,2.508,0,0,0,0,5.834V22.5A2.5,2.5,0,0,0,2.5,25H22.916a1.25,1.25,0,0,0,1.25-1.25V18.673A1.25,1.25,0,0,0,25,17.5V15a1.25,1.25,0,0,0-.833-1.173Zm-1.25-9.243V7.5H20.761a5.442,5.442,0,0,0,.071-.833,5.382,5.382,0,0,0-.611-2.5H22.5A.417.417,0,0,1,22.916,4.584Zm-3.776-.59A4.476,4.476,0,0,1,19.916,7.5h-9A4.579,4.579,0,0,1,19.14,3.994ZM9.166.834A4.57,4.57,0,0,1,12.4,2.169,5.343,5.343,0,0,0,10.071,7.5H5.091A4.572,4.572,0,0,1,9.166.834Zm-8.333,5A1.673,1.673,0,0,1,2.5,4.167H3.9A5.369,5.369,0,0,0,4.164,7.5H2.587A1.732,1.732,0,0,1,.837,5.987a1.282,1.282,0,0,1,0-.15ZM22.916,24.166H2.5A1.667,1.667,0,0,1,.833,22.5V19.166H3.579a.839.839,0,0,1,.642.3l.677.815a1.692,1.692,0,1,0,.642-.531l-.679-.816a1.667,1.667,0,0,0-1.284-.6H.833V16.666H7.976a1.667,1.667,0,1,0,0-.833H.833V14.167H3.579a1.67,1.67,0,0,0,1.283-.6l.68-.817a1.647,1.647,0,0,0,.708.167,1.678,1.678,0,1,0-1.351-.7l-.676.813a.84.84,0,0,1-.644.3H.833V7.667a2.642,2.642,0,0,0,1.754.667H22.916a.417.417,0,0,1,.417.417v5H21.249a2.5,2.5,0,0,0,0,5h2.083v5A.417.417,0,0,1,22.916,24.166ZM6.25,20.416a.833.833,0,1,1-.833.833A.833.833,0,0,1,6.25,20.416Zm2.5-4.167a.833.833,0,1,1,.833.833A.833.833,0,0,1,8.75,16.25Zm-3.333-5a.833.833,0,1,1,.833.833A.833.833,0,0,1,5.416,11.25ZM24.166,17.5a.417.417,0,0,1-.417.417h-2.5a1.667,1.667,0,0,1,0-3.333h2.5a.417.417,0,0,1,.417.417Z", transform: "translate(0 0)", fill: fgColor }) })
  ] });
};
var SettingIcon = ({ active = false, ...props }) => {
  const fgColor = active ? "#F4F5F5" : "#a2a0a0";
  const bgColor = active ? "#404040" : "#F4F5F5";
  return /* @__PURE__ */ jsxs31("svg", { id: "_25x25_Back", "data-name": "25x25 Back", xmlns: "http://www.w3.org/2000/svg", width: "25", height: "25", viewBox: "0 0 25 25", ...props, children: [
    /* @__PURE__ */ jsx45("rect", { width: "25", height: "25", rx: "2", fill: bgColor }),
    /* @__PURE__ */ jsx45("g", { id: "Mask_Group_618", "data-name": "Mask Group 618", children: /* @__PURE__ */ jsxs31("g", { id: "settings-11", transform: "translate(0 1.251)", children: [
      /* @__PURE__ */ jsx45("path", { id: "Path_22821", "data-name": "Path 22821", d: "M.417,3.332H2.95a2.913,2.913,0,0,0,5.767,0H24.583a.417.417,0,1,0,0-.833H8.717a2.913,2.913,0,0,0-5.767,0H.417a.417.417,0,1,0,0,.833ZM5.833.832A2.083,2.083,0,1,1,3.75,2.916,2.083,2.083,0,0,1,5.833.832Zm0,0", fill: fgColor }),
      /* @__PURE__ */ jsx45("path", { id: "Path_22822", "data-name": "Path 22822", d: "M.417,11.666h14.2a2.913,2.913,0,0,0,5.767,0h4.2a.417.417,0,1,0,0-.833h-4.2a2.913,2.913,0,0,0-5.767,0H.417a.417.417,0,1,0,0,.833ZM17.5,9.166a2.083,2.083,0,1,1-2.083,2.083A2.083,2.083,0,0,1,17.5,9.166Zm0,0", fill: fgColor }),
      /* @__PURE__ */ jsx45("path", { id: "Path_22823", "data-name": "Path 22823", d: "M.417,20H5.45a2.913,2.913,0,0,0,5.767,0H24.583a.417.417,0,1,0,0-.833H11.217a2.913,2.913,0,0,0-5.767,0H.417a.417.417,0,1,0,0,.833Zm7.917-2.5A2.083,2.083,0,1,1,6.25,19.582,2.083,2.083,0,0,1,8.333,17.5Zm0,0", fill: fgColor })
    ] }) })
  ] });
};
...
var UniversalLink = ({ href, children, ...props }) => {
  const { isLibrary } = useRDBConfig();
  if (isLibrary) {
    return /* @__PURE__ */ jsx46(RouterLink, { to: href, ...props, children });
  }
  return /* @__PURE__ */ jsx46(Link, { href, ...props, children });
};
...
var Footer = () => {
  ...
  return /* @__PURE__ */ jsx47("footer", { className: "w-full bg-[#F4F5F5] py-2 px-6 md:px-16 lg:px-24", children: /* @__PURE__ */ jsx47("div", { className: "flex items-center justify-between w-full", children: items.map((item) => {
    ...
    return /* @__PURE__ */ jsxs32(
      UniversalLink,
      {
        ...
        children: [
          /* @__PURE__ */ jsx47("div", { className: "w-10.5 h-6 relative flex items-center justify-center", children: /* @__PURE__ */ jsx47(IconComponent, { className: "object-contain", active: isActive }) }),
          /* @__PURE__ */ jsx47(
            "span",
            {
...
import { createContext as createContext8, useContext as useContext8, useState as useState23, useCallback as useCallback16, useRef as useRef14 } from "react";
import { jsx as jsx48 } from "react/jsx-runtime";
var ScannerContext = createContext8(void 0);
var ScannerProvider = ({ children }) => {
  const [open, setOpen] = useState23(null);
  const [isTransferScan, setIsTransferScan] = useState23(false);
  const onQrScannedRef = useRef14(null);
  const scannerNavRef = useRef14({});
  const setOnQrScanned = useCallback16((cb) => {
    onQrScannedRef.current = cb;
    if (!cb) setIsTransferScan(false);
  }, []);
  const setScannerNav = useCallback16((nav) => {
    scannerNavRef.current = nav;
  }, []);
  const openScannerWithCallback = useCallback16((callback) => {
    onQrScannedRef.current = callback;
    setIsTransferScan(true);
    scannerNavRef.current.toScan?.();
  }, []);
  const callOnQrScanned = useCallback16((value) => {
...
var useScanner = () => {
  const context = useContext8(ScannerContext);
  if (context === void 0) {
...
var Header = () => {
  ...
  return /* @__PURE__ */ jsxs33("header", { className: "relative w-full h-[min(16.37vw,7.6vh)] bg-white flex items-end justify-between px-[min(5.58vw,2.57vh)]", children: [
    /* @__PURE__ */ jsx49("div", { className: "flex h-full items-center gap-3", children: /* @__PURE__ */ jsx49("div", { className: "relative w-[min(13.95vw,6.44vh)] h-[min(8.98vw,4.22vh)]", children: /* @__PURE__ */ jsx49(
      Image15,
      {
    ...
    /* @__PURE__ */ jsxs33("div", { className: "flex items-center gap-7.5 mb-2", children: [
      activeAssetSymbol && /* @__PURE__ */ jsxs33("div", { className: "flex flex-col items-center gap-2", children: [
        /* @__PURE__ */ jsx49(
          "div",
          {
        ...
        /* @__PURE__ */ jsx49("span", { className: "font-quicksand font-normal text-[11px] text-[#404040] leading-none", children: t.header.receive })
      ] }),
      activeAssetSymbol && /* @__PURE__ */ jsxs33("div", { className: "flex flex-col items-center gap-2", children: [
        /* @__PURE__ */ jsx49(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx49(Image15, { src: send_default, alt: "Send", fill: true, className: "object-contain" })
          }
        ),
        /* @__PURE__ */ jsx49("span", { className: "font-quicksand font-normal text-[11px] text-[#404040] leading-none", children: t.header.send })
      ] }),
      /* @__PURE__ */ jsxs33("div", { className: "flex flex-col justify-start items-start gap-3", children: [
        /* @__PURE__ */ jsx49(
          "div",
          {
        ...
        /* @__PURE__ */ jsx49("span", { className: "font-quicksand font-normal text-[11px] text-[#404040] leading-none" })
      ] })
    ] }),
    /* @__PURE__ */ jsx49("div", { className: "absolute bottom-0 left-[min(5.58vw,2.57vh)] right-[min(5.58vw,2.57vh)] h-px bg-[#d3d3d35e]" })
  ] });
};
var Header_default = Header;

// src/components/QR/scanner/GlobalQrScanner.tsx
import { useRef as useRef19, useState as useState28 } from "react";

// src/components/QR/send/index.tsx
import React29, { useState as useState27, useEffect as useEffect21 } from "react";

// src/components/QR/send/Scan.tsx
import { useCallback as useCallback17, useEffect as useEffect16, useRef as useRef15, useState as useState24 } from "react";
...
var QrScanner = ({ onScan, onClose, onSend }) => {
  ...
  const scannerRef = useRef15(null);
  const { open: openType, isTransferScan } = useScanner();
  const [error, setError] = useState24(null);
  const [isLoading, setIsLoading] = useState24(true);
  const [facingMode, setFacingMode] = useState24(DEFAULT_CAMERA);
  const [retryCount, setRetryCount] = useState24(0);
  const switchCamera = useCallback17(async () => {
  ...
  return /* @__PURE__ */ jsxs34("div", { className: "w-full h-full flex-1 flex flex-col items-center px-6 pt-2", children: [
    /* @__PURE__ */ jsxs34("div", { className: "relative w-full aspect-square max-w-85 bg-black rounded-[40px] overflow-hidden shadow-2xl flex items-center justify-center", children: [
      /* @__PURE__ */ jsx50(
        "video",
        {
          ref: videoRef,
        ...
        "button",
        {
          ...
          children: /* @__PURE__ */ jsxs34(
            "svg",
            {
              ...
              children: [
                /* @__PURE__ */ jsx50("path", { d: "M11 19H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h5" }),
                /* @__PURE__ */ jsx50("path", { d: "M13 5h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5" }),
                /* @__PURE__ */ jsx50("circle", { cx: "12", cy: "12", r: "3" }),
                /* @__PURE__ */ jsx50("path", { d: "m18 22-3-3 3-3" })
              ]
            }
          )
        }
      ),
      isLoading && /* @__PURE__ */ jsx50("div", { className: "absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-10", children: /* @__PURE__ */ jsx50("div", { className: "w-10 h-10 border-4 border-white/20 border-t-white rounded-full animate-spin" }) }),
      /* @__PURE__ */ jsxs34("div", { className: "absolute bottom-0 inset-x-0 z-10 flex flex-col items-center", children: [
        /* @__PURE__ */ jsx50("div", { className: "w-12 h-12 flex items-center justify-center text-white", children: /* @__PURE__ */ jsx50(
          Image16,
          {
        ...
        /* @__PURE__ */ jsx50("p", { className: "font-quicksand text-[#FCFCFC] text-[11px] font-normal text-center px-1 pb-2 leading-tight opacity-90", children: t.home.qr.scanner.readCode })
      ] }),
      /* @__PURE__ */ jsx50("div", { className: "absolute inset-0 border-[3px] border-white/10 pointer-events-none rounded-[40px]" })
    ] }),
    error && /* @__PURE__ */ jsx50("div", { className: "mt-4 px-4 py-2 bg-red-50 rounded-full border border-red-100 flex items-center gap-3", children: /* @__PURE__ */ jsx50("p", { className: "text-red-500 text-xs font-medium flex-1", children: error }) }),
    /* @__PURE__ */ jsx50("div", { className: "flex-1 min-h-5" }),
    openType === "send" && !isTransferScan && /* @__PURE__ */ jsxs34("div", { className: "w-full flex items-center gap-4 mb-4", children: [
      /* @__PURE__ */ jsx50("div", { className: "h-px flex-1 bg-gray-100/60" }),
      /* @__PURE__ */ jsx50("span", { className: "text-[#1D1D1D] text-[13px] font-normal", children: t.home.qr.scanner.orChoose }),
      /* @__PURE__ */ jsx50("div", { className: "h-px flex-1 bg-gray-100/60" })
    ] }),
    openType === "send" && !isTransferScan && /* @__PURE__ */ jsxs34("div", { className: "w-full flex flex-col gap-1 px-1 pb-4", children: [
      /* @__PURE__ */ jsxs34(
        "button",
        {
          onClick: onSend,
          ...
          children: [
            /* @__PURE__ */ jsx50("div", { className: "w-6.25 h-6.25 rounded-lg flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsx50(Image16, { src: send_default, alt: "Send", width: 22, height: 22 }) }),
            /* @__PURE__ */ jsxs34("div", { className: "flex-1 text-left", children: [
              /* @__PURE__ */ jsx50("h3", { className: "font-quicksand text-[#1D1D1D] text-[13px] font-medium leading-tight", children: t.home.qr.scanner.sendTitle }),
              /* @__PURE__ */ jsx50("p", { className: "text-[#8D8D8D] text-[11px] mt-0.5 font-normal", children: t.home.qr.scanner.sendDescription })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxs34("button", { className: "cursor-pointer w-full flex items-center gap-4 p-4 bg-[#F8F8F8] rounded-2xl transition-colors group", children: [
        /* @__PURE__ */ jsx50("div", { className: "w-6.25 h-6.25 rounded-lg flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsx50(Image16, { src: receive_default, alt: "Receive", width: 22, height: 22 }) }),
        /* @__PURE__ */ jsxs34("div", { className: "flex-1 text-left", children: [
          /* @__PURE__ */ jsx50("h3", { className: "font-quicksand text-[#1D1D1D] text-[13px] font-medium leading-tight", children: t.home.qr.scanner.receiveTitle }),
          /* @__PURE__ */ jsx50("p", { className: "text-[#8D8D8D] text-[11px] mt-0.5 font-normal", children: t.home.qr.scanner.receiveDescription })
        ] })
      ] })
    ] })
  ] });
...
var SendChoose = ({ onNavigate }) => {
  ...
  return /* @__PURE__ */ jsxs35("div", { className: "flex flex-col items-center px-6 pb-4 w-full max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxs35("div", { className: "flex flex-col items-center mb-4", children: [
      /* @__PURE__ */ jsx51("div", { className: "rounded-xl mb-4", children: /* @__PURE__ */ jsx51(Image17, { src: send_default, alt: "Send", width: 40, height: 40 }) }),
      /* @__PURE__ */ jsx51("h2", { className: "font-quicksand text-[13px] font-medium tracking-widest text-[#1D1D1D] uppercase", children: tr2("send.header_title") })
    ] }),
    /* @__PURE__ */ jsx51("div", { className: "w-full space-y-1", children: OPTIONS.map((option, i) => /* @__PURE__ */ jsxs35(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs35("div", { className: "flex items-end justify-between w-full", children: [
            /* @__PURE__ */ jsxs35("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx51("div", { className: "w-12 h-12 flex items-center justify-center", children: /* @__PURE__ */ jsx51(
                Image17,
                {
                  src: option.icon,
                  alt: option.iconAlt,
              ...
              /* @__PURE__ */ jsxs35("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsx51("span", { className: "font-quicksand text-[#1D1D1D] text-[13px] font-medium", children: option.label }),
                /* @__PURE__ */ jsx51("span", { className: "font-quicksand text-[11px] text-[#8D8D8D] font-normal", children: option.sublabel })
              ] })
            ] }),
            /* @__PURE__ */ jsx51("div", { className: "flex flex-col items-end p-2 gap-1", children: option.links.map((link, j) => /* @__PURE__ */ jsx51(
              "span",
              {
          ...
          option.merchants && /* @__PURE__ */ jsx51("div", { className: "flex items-center justify-between gap-1 px-3 overflow-x-auto no-scrollbar py-0", children: option.merchants.map((logo, j) => /* @__PURE__ */ jsxs35(
            "div",
            {
              className: "relative w-17.5 gap-1 flex flex-col items-center",
              children: [
                /* @__PURE__ */ jsx51("div", { className: "relative w-17.5 h-16 rounded-full flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsx51(
                  Image17,
                  {
                    src: logo.src,
                    alt: logo.label,
                ...
                /* @__PURE__ */ jsx51("span", { className: "text-[13px] text-[#1D1D1D] font-quicksand font-normal", children: logo.label })
              ]
            },
            j
          )) })
...
var ScannedData = ({ parsedQR, onClose }) => {
  const { t } = useTranslation();
  const { toast } = useToast();
  const [isInitialLoading, setIsInitialLoading] = useState25(true);
  const [amount, setAmount] = useState25(parsedQR.amount || "");
  const [isSending, setIsSending] = useState25(false);
  const validities = [
    { id: "Always", label: t.home.qr.validity.always },
    { id: "1m", label: t.home.qr.validity.m1 },
    { id: "3m", label: t.home.qr.validity.m3 },
  ...
  return /* @__PURE__ */ jsxs36("div", { className: "flex flex-col items-center w-full max-w-100 mx-auto h-full relative overflow-hidden", children: [
    /* @__PURE__ */ jsxs36("div", { className: "flex-1 w-full flex flex-col pt-2 overflow-hidden", children: [
      /* @__PURE__ */ jsx52("div", { className: "flex flex-col items-center w-full", children: /* @__PURE__ */ jsx52("div", { className: "relative w-25 h-7", children: /* @__PURE__ */ jsx52(Image18, { src: title_default, alt: "Title Icon", fill: true, className: "object-contain" }) }) }),
      /* @__PURE__ */ jsxs36("div", { className: "flex flex-col items-center w-full pt-4 pb-2", children: [
        /* @__PURE__ */ jsx52("div", { className: "relative w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsx52(
          "div",
          {
            className: "w-full h-full flex items-center justify-center",
            style: { background: PROFILE_GRADIENT },
            children: /* @__PURE__ */ jsx52("span", { className: "text-white text-xl font-semibold", children: qrInitials })
          }
        ) }),
        /* @__PURE__ */ jsx52("p", { className: "font-quicksand text-xs font-light text-gray-400 mt-2", children: accountName })
      ] }),
      /* @__PURE__ */ jsx52("div", { className: "flex-1 relative overflow-hidden flex flex-col pt-1", children: /* @__PURE__ */ jsx52("div", { className: "w-full flex flex-col h-full overflow-hidden relative", children: /* @__PURE__ */ jsxs36("div", { className: "w-full flex-1 overflow-y-auto pb-20 transition-all duration-300", children: [
        /* @__PURE__ */ jsx52("div", { className: "pt-4 w-full", children: /* @__PURE__ */ jsx52(
          AccountInfo,
          {
            hideRequired: true,
            reviewMode: true,
        ...
        /* @__PURE__ */ jsxs36("div", { className: "w-full flex flex-col gap-4 pt-2", children: [
          /* @__PURE__ */ jsxs36("div", { className: "flex gap-2 w-full", children: [
            /* @__PURE__ */ jsx52(
              Input_default,
              {
                id: "send-amount-hide",
            ...
            parsedQR.reference && /* @__PURE__ */ jsx52(
              Input_default,
              {
                hideRequired: true,
                reviewMode: true,
          ...
          parsedQR.purpose && /* @__PURE__ */ jsxs36("div", { className: "flex gap-2 w-full", children: [
            /* @__PURE__ */ jsx52(
              Input_default,
              {
                hideRequired: true,
          ...
          parsedQR.note && /* @__PURE__ */ jsx52(NoteField, { value: parsedQR.note, disabled: true }),
          parsedQR.validity && parsedQR.validity !== "Always" && /* @__PURE__ */ jsx52(
            Input_default,
            {
              hideRequired: true,
              reviewMode: true,
              ...
              className: "text-[11px]!",
              containerClassName: "w-1/2",
              description: /* @__PURE__ */ jsx52("p", { className: "font-quicksand mt-2 text-center text-[11px] font-normal text-[#1D1D1D] px-1", children: t.home.qr.validityDescription })
            }
          )
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsx52("div", { className: "absolute bottom-0 left-0 right-0 bg-background border-0 border-[#F2F2F2]", children: /* @__PURE__ */ jsxs36("div", { className: "flex items-center justify-center gap-13 px-6 py-4", children: [
        /* @__PURE__ */ jsx52(
          ActionButton,
          {
            icon: sendT_default,
    ...
    (isInitialLoading || isSending) && /* @__PURE__ */ jsxs36(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx52("div", { className: "w-12 h-12 border-4 border-emerald-200 border-t-[#3C3C3C] rounded-full animate-spin" }),
          /* @__PURE__ */ jsx52("p", { className: "font-quicksand text-sm font-light text-gray-700", children: t.home.qr.messages.processingTransfer })
        ]
      }
    )
  ] });
...
import { useState as useState26, useCallback as useCallback18, useEffect as useEffect20, useRef as useRef18 } from "react";
...
// src/components/QR/send/transfer/RecipientInput.tsx
import { Fragment as Fragment3, jsx as jsx53, jsxs as jsxs37 } from "react/jsx-runtime";
var RecipientInput = ({
  value,
  onChange,
  onValidate,
  ...
  const shouldFocusAfterEditRef = useRef16(false);
  useEffect18(() => {
  ...
  if (accountConfirmed && recipientDetails) {
    return /* @__PURE__ */ jsxs37("div", { className: "flex flex-col gap-0 rounded-[15px] w-full p-2 bg-[#F7F7F7]", children: [
      /* @__PURE__ */ jsxs37("div", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsx53("span", { className: "text-[11px] text-[#8D8D8D] font-medium", children: t.transfer.recipient.recipientAccountNumber }),
        /* @__PURE__ */ jsx53(Image19, { width: 14, height: 14, src: info_default, alt: "Info" })
      ] }),
      /* @__PURE__ */ jsxs37("div", { className: "flex items-center gap-1", children: [
        inputMethod === "QR" && /* @__PURE__ */ jsx53(
          Image19,
          {
            src: qrinputmethod_default,
            alt: "QR Input",
        ...
        /* @__PURE__ */ jsxs37("p", { className: "text-[13px] mt-2 font-medium text-[#1D1D1D]", children: [
  ...
  return /* @__PURE__ */ jsx53("div", { className: "flex flex-col gap-1", children: /* @__PURE__ */ jsxs37(
    "div",
    {
      onClick: () => inputRef.current?.focus(),
      ...
      children: [
        /* @__PURE__ */ jsxs37("div", { className: "relative", children: [
          /* @__PURE__ */ jsxs37("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx53("span", { className: "text-[11px] text-[#1D1D1D] font-medium", children: t.transfer.recipient.enter }),
            /* @__PURE__ */ jsxs37(Fragment3, { children: [
              /* @__PURE__ */ jsx53(
                "button",
                {
              ...
              /* @__PURE__ */ jsx53("span", { className: "text-[11px] text-[#1D1D1D] font-medium", children: t.transfer.recipient.or }),
              /* @__PURE__ */ jsx53(Image19, { width: 14, height: 14, src: phone_default, alt: "Phone Input" }),
              /* @__PURE__ */ jsx53(
                "button",
                {
          ...
          /* @__PURE__ */ jsxs37("div", { className: `flex items-center gap-1 ${rtl ? "pl-15.5" : "pr-15.5"}`, children: [
            inputMode === "phone" && /* @__PURE__ */ jsx53("span", { className: "text-[13px] font-medium text-[#1D1D1D]", children: "+" }),
            /* @__PURE__ */ jsx53(
              "input",
              {
                ref: inputRef,
          ...
          /* @__PURE__ */ jsx53("div", { className: `absolute ${rtl ? "left-2" : "right-2"} top-1/2 -translate-y-1/2 flex flex-col items-end justify-center gap-1 shrink-0`, children: isValidating ? /* @__PURE__ */ jsx53("div", { className: "w-4 h-4 border-2 border-gray-200 border-t-[#3C3C3C] rounded-full animate-spin shrink-0" }) : !value ? inputMode === "account" && /* @__PURE__ */ jsxs37("div", { className: "flex items-center justify-end gap-3", children: [
            onPaste && /* @__PURE__ */ jsx53(
              "button",
              {
                onClick: onPaste,
                className: "cursor-pointer text-[11px] text-[#388CFF] font-medium",
        ...
        error && /* @__PURE__ */ jsx53("div", { className: "bg-red-50 rounded-xl px-4 py-2.5 mt-1", children: /* @__PURE__ */ jsx53("p", { className: "text-[11px] text-red-500 font-medium text-center", children: error }) }),
        currencyWarning && !error && /* @__PURE__ */ jsx53("div", { className: "bg-amber-50 rounded-xl px-4 py-2.5 mt-1", children: /* @__PURE__ */ jsx53("p", { className: "text-[11px] text-amber-600 font-medium text-center", children: currencyWarning }) })
      ]
    }
  ) });
};
...
var AmountInput = ({
  ...
  if (amountConfirmed) {
    return /* @__PURE__ */ jsxs38("div", { className: "flex flex-col gap-1 rounded-[15px] w-full p-2 bg-[#F7F7F7] border border-[#d3d3d35e]", children: [
      /* @__PURE__ */ jsxs38("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx54("button", { onClick: onEdit, className: "text-[11px] text-[#388CFF] font-medium", children: t.transfer.amountInput.edit }),
        /* @__PURE__ */ jsx54(
          "span",
          {
      ...
      /* @__PURE__ */ jsxs38("p", { className: "text-[13px] font-medium text-[#1D1D1D]", children: [
        /* @__PURE__ */ jsxs38("span", { className: "text-[13px] font-bold text-[#1D1D1D]", children: [
          value,
          " "
        ] }),
        "  ",
  ...
  return /* @__PURE__ */ jsx54("div", { className: "flex flex-col gap-1", children: /* @__PURE__ */ jsxs38(
    "div",
    {
      onClick: () => inputRef.current?.focus(),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs38("div", { className: "flex items-center gap-1 cursor-text", children: [
          /* @__PURE__ */ jsx54(
            "input",
            {
              ref: inputRef,
          ...
          /* @__PURE__ */ jsx54("span", { className: "text-[13px] font-medium text-[#1D1D1D] shrink-0", children: currency }),
          /* @__PURE__ */ jsx54("div", { className: "absolute right-2 top-1/2 -translate-y-1/2 flex flex-col items-end justify-center gap-1 shrink-0", children: isChecking && /* @__PURE__ */ jsx54("div", { className: "w-4 h-4 border-2 border-gray-200 border-t-[#3C3C3C] rounded-full animate-spin shrink-0" }) })
        ] }),
        error && /* @__PURE__ */ jsx54("div", { className: "bg-red-50 rounded-xl px-4 py-2.5 mt-1", children: /* @__PURE__ */ jsx54("p", { className: "text-[11px] text-red-500 font-medium text-center", children: error }) })
      ]
    }
  ) });
};
...
var PurposeSelect = ({ selectedId, onSelect, note, onChangeNote }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxs39("div", { className: "flex flex-col gap-2 px-2", children: [
      /* @__PURE__ */ jsx55("span", { className: "text-[11px] text-[#8D8D8D] font-medium", children: tr2("send.purpose_select_label") }),
      /* @__PURE__ */ jsx55("div", { className: "flex gap-2", children: Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsx55(
        "div",
        {
  ...
  if (error) {
    return /* @__PURE__ */ jsxs39("div", { className: "flex flex-col gap-2 px-2", children: [
      ...
      /* @__PURE__ */ jsxs39("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx55("span", { className: "text-[12px] text-red-500", children: error }),
        /* @__PURE__ */ jsx55(
          "button",
          {
            onClick: retry,
  ...
  return /* @__PURE__ */ jsxs39("div", { className: `flex rounded-[15px] p-2
    ...
    /* @__PURE__ */ jsxs39("div", { className: "mt-1 flex items-center gap-2 px-2", children: [
      /* @__PURE__ */ jsx55(Image20, { width: 16, height: 16, src: note_default, alt: "Note Icon" }),
      /* @__PURE__ */ jsx55(
        "input",
        {
          type: "text",
...
var TransferSuccess = ({
  ...
  return /* @__PURE__ */ jsx56(SuccessReceipt_default, { data: receiptData, onClose });
};
...
var TransferSend = ({ onClose }) => {
  ...
  const { t, tr: tr2 } = useTranslation();
  const [form, setForm] = useState26(initialFormState);
  const [selectedPurposeName, setSelectedPurposeName] = useState26("");
  const [pendingQrValidation, setPendingQrValidation] = useState26(null);
  const [pendingPasteValidation, setPendingPasteValidation] = useState26(null);
  const recipientValidateDebounceRef = useRef18(null);
  const senderBalance = activeAssetSymbol ? balances[activeAssetSymbol] : void 0;
  ...
  const validateAccountByNumber = useCallback18(
    async (accountNumber) => {
  ...
  const handleValidateAccount = useCallback18(async () => {
  ...
  const handleValidateAmount = useCallback18(async () => {
  ...
  if (form.isSuccess && form.transferResult) {
    return /* @__PURE__ */ jsx57("div", { className: "w-full h-full overflow-y-auto", children: /* @__PURE__ */ jsx57("div", { className: "max-w-93.75 mx-auto h-full", children: /* @__PURE__ */ jsx57(
  ...
  return /* @__PURE__ */ jsx57("div", { className: "w-full h-full overflow-y-auto relative flex flex-col", children: /* @__PURE__ */ jsxs40("div", { className: "max-w-93.75 mx-auto relative w-full text-white flex flex-col flex-1", children: [
    /* @__PURE__ */ jsxs40("div", { className: "flex flex-col items-center mb-4 pt-0", children: [
      /* @__PURE__ */ jsx57("div", { className: "mb-1", children: /* @__PURE__ */ jsx57(Image21, { src: sendT_default, alt: "Transfer", width: 40, height: 40 }) }),
      /* @__PURE__ */ jsx57("h2", { className: "font-quicksand text-[13px] font-medium tracking-widest text-[#1D1D1D] uppercase", children: t.transfer.title })
    ] }),
    /* @__PURE__ */ jsx57(SenderCard_default, {}),
    /* @__PURE__ */ jsx57("p", { className: "text-[11px] text-[#1D1D1D] font-medium text-center mt-2 mb-2", children: t.transfer.sendTo }),
    /* @__PURE__ */ jsxs40("div", { className: "overflow-auto pb-20", children: [
      /* @__PURE__ */ jsx57(
    ...
    /* @__PURE__ */ jsx57("div", { className: "flex-1" }),
    /* @__PURE__ */ jsx57("div", { className: "flex w-full bg-white flex-col absolute bottom-0 items-center py-6 mt-4", children: /* @__PURE__ */ jsxs40(
      "button",
      {
        onClick: handleSend,
        ...
        children: [
          canSend ? /* @__PURE__ */ jsx57(Image21, { src: transfer_default, alt: "Transfer", width: 25, height: 25 }) : /* @__PURE__ */ jsx57(
            Image21,
            {
          ...
          /* @__PURE__ */ jsx57("span", { className: "text-[13px] font-medium", children: form.isSending ? t.transfer.sendingButton : t.transfer.sendButton })
        ]
      }
    ) })
  ] }) });
...
var QrScanner2 = ({ open, onClose, onScan, parsedQR, paymentRequestCode }) => {
  const [page, setPage] = useState27("scan");
                ...
                children: [
                  /* @__PURE__ */ jsx58(
                    "svg",
                    {
                      ...
                      strokeLinecap: "round",
                      strokeLinejoin: "round",
                      children: /* @__PURE__ */ jsx58("path", { d: "M15 18l-6-6 6-6" })
                    }
                  ),
                  /* @__PURE__ */ jsx58("span", { className: "text-[13px] font-medium", children: t.common.accessibility.back })
                ]
              }
            )
          }
        ),
        /* @__PURE__ */ jsx58("div", { className: "overflow-hidden h-full w-full", children: /* @__PURE__ */ jsxs41(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: /* @__PURE__ */ jsx58(
                Scan_default,
                {
                  onScan,
                  onClose: handleClose,
              ...
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: parsedQR && /* @__PURE__ */ jsx58(ScannedData_default, { parsedQR, onClose: handleClose }) }),
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: /* @__PURE__ */ jsx58(SendChoose_default, { onNavigate: navigate }) }),
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: /* @__PURE__ */ jsx58(transfer_default2, { onClose: handleClose }) }),
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: parsedQR && /* @__PURE__ */ jsx58(
                PaymentRequestReview_default,
                {
                  parsedQR,
                  onDone: handleClose,
              ...
              /* @__PURE__ */ jsx58("div", { className: "w-full shrink-0 h-full", children: paymentRequestCode && /* @__PURE__ */ jsx58(
                PaymentRequestReview_default,
                {
...
var GlobalQrScanner = () => {
  ...
  const { toast } = useToast();
  const [parsedQR, setParsedQR] = useState28(null);
  const lastInvalidScanRef = useRef19(0);
  const lastHandledScanRef = useRef19(0);
  const errorMessages = {
  ...
  if (open === "receive") {
    return /* @__PURE__ */ jsx59(BottomSheet_default, { onClose: handleClose, open: true, children: /* @__PURE__ */ jsx59(
      CreatePaymentRequest_default,
      {
        account,
        balances,
...
function ProtectedLayout({ children }) {
  return /* @__PURE__ */ jsx60(AuthProtected, { children: /* @__PURE__ */ jsxs42("div", { className: "flex flex-col h-full w-full", children: [
    /* @__PURE__ */ jsx60(Header_default, {}),
    /* @__PURE__ */ jsx60("main", { className: "flex-1 overflow-y-auto max-w-full", children }),
    /* @__PURE__ */ jsx60(Footer_default, {}),
    /* @__PURE__ */ jsx60(GlobalQrScanner_default, {})
  ] }) });
}
...
import { Phone as Phone2 } from "lucide-react";
...
function AuthLayout({ children, title, showPhoneIcon = true }) {
  ...
  return /* @__PURE__ */ jsxs43("div", { className: "w-full h-screen flex flex-col bg-white overflow-hidden", children: [
    /* @__PURE__ */ jsxs43("div", { className: "h-6/10 w-full flex flex-col items-center justify-end pb-4 px-6 pt-10", children: [
      /* @__PURE__ */ jsxs43("div", { className: "flex flex-col items-center text-center pb-4", children: [
        /* @__PURE__ */ jsx61("h2", { className: "text-[28px] font-medium text-gray-800 mb-6", children: displayTitle }),
        showPhoneIcon && /* @__PURE__ */ jsx61("div", { className: "mb-2", children: /* @__PURE__ */ jsx61(Phone2, { className: "w-8 h-8 text-gray-400 stroke-[1.5px]" }) })
      ] }),
      /* @__PURE__ */ jsx61("div", { className: "w-full flex flex-col items-center", children })
    ] }),
    /* @__PURE__ */ jsxs43("div", { className: "h-4/10 hidden w-full relative", children: [
      /* @__PURE__ */ jsx61("div", { className: "absolute inset-0 bg-black/50 backdrop-blur-2xl" }),
      /* @__PURE__ */ jsx61("div", { className: "absolute top-0 left-0 right-0 h-px bg-white/5" })
    ] })
  ] });
}

// src/components/ui/PhoneInput.tsx
import { useState as useState29, useCallback as useCallback19, useMemo as useMemo7 } from "react";
import { Phone as Phone3, ArrowRight, Loader2 as Loader22 } from "lucide-react";
...
function PhoneInput({
  ...
  const detectedCountry = useMemo7(() => {
  ...
  const formatNumber = useCallback19((digits) => {
    if (!digits) return "";
    let matchedDialCode = "";
    for (const country of SORTED_COUNTRIES) {
      if (digits.startsWith(country.dialCode)) {
  ...
  return /* @__PURE__ */ jsx62("div", { className: "flex w-full items-center justify-center", children: /* @__PURE__ */ jsxs44(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx62(Phone3, { className: "w-4.5 h-4.5 text-foreground/50 shrink-0" }),
        detectedCountry && /* @__PURE__ */ jsx62("span", { className: "w-6 h-4.5 shrink-0 overflow-hidden rounded-sm", children: /* @__PURE__ */ jsx62(
          "img",
          {
        ...
        /* @__PURE__ */ jsx62("span", { className: "text-foreground/60 text-[14px] shrink-0 select-none", children: "+" }),
        /* @__PURE__ */ jsx62(
          "input",
          {
            type: "tel",
        ...
        isValidPhone && onSend && /* @__PURE__ */ jsx62(
          "button",
          {
            onClick: onSend,
            disabled: isLoading,
            ...
            children: isLoading ? /* @__PURE__ */ jsx62(Loader22, { className: "w-5 h-5 text-primary animate-spin" }) : /* @__PURE__ */ jsx62(ArrowRight, { className: "w-5 h-5 text-primary" })
          }
        )
      ]
    }
...
function EnterPhoneScreen({
  ...
  return /* @__PURE__ */ jsx63(
    AuthLayout,
    {
      ...
      showPhoneIcon: true,
      children: /* @__PURE__ */ jsxs45("div", { className: "w-full max-w-95 space-y-6", children: [
        /* @__PURE__ */ jsxs45("div", { className: "space-y-4 pb-12", children: [
          /* @__PURE__ */ jsx63("p", { className: "text-[14px] text-gray-500 text-center font-normal", children: t.auth.enterPhone.enterPhoneInstruction }),
          /* @__PURE__ */ jsxs45("div", { className: "flex flex-col items-center space-y-3 px-2", children: [
            /* @__PURE__ */ jsxs45("div", { className: "flex items-center gap-3 w-full justify-center", children: [
              /* @__PURE__ */ jsx63(CheckSquare, { className: "w-4 h-4 text-gray-400 shrink-0" }),
              /* @__PURE__ */ jsx63("span", { className: "text-[13px] text-gray-500", children: t.auth.enterPhone.verificationInfo })
            ] }),
            /* @__PURE__ */ jsxs45("div", { className: "flex items-start gap-3 w-full justify-center", children: [
              /* @__PURE__ */ jsx63(Info, { className: "w-4 h-4 text-blue-500 shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxs45("span", { className: "text-[13px] text-gray-500 text-center leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsx63("div", { className: "px-4", children: /* @__PURE__ */ jsx63(
          PhoneInput,
          {
...
var RdbIcon = (props) => /* @__PURE__ */ jsx65(
  Image22,
  {
    src: rdb_default,
    alt: "RDB Logo",
...
var LoaderBarIcon = ({ percent = 100, ...props }) => {
  ...
  return /* @__PURE__ */ jsx65("svg", { xmlns: "http://www.w3.org/2000/svg", width: "147", height: "5", viewBox: "0 0 147 5", ...props, children: /* @__PURE__ */ jsx65("g", { id: "Group_11964", "data-name": "Group 11964", transform: "translate(-98 -529)", children: /* @__PURE__ */ jsxs46("g", { id: "Group_11963", "data-name": "Group 11963", transform: "translate(98 529)", children: [
    /* @__PURE__ */ jsxs46("g", { id: "Rectangle_5503", "data-name": "Rectangle 5503", fill: "none", stroke: "#707070", strokeWidth: "0.5", children: [
      /* @__PURE__ */ jsx65("rect", { width: "146", height: "5", rx: "2.5", stroke: "none" }),
      /* @__PURE__ */ jsx65("rect", { x: "0.25", y: "0.25", width: "145.5", height: "4.5", rx: "2.25", fill: "none" })
    ] }),
    /* @__PURE__ */ jsx65(
      "rect",
      {
...
function GetStartedScreen({
  ...
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs47("main", { className: "w-full h-full flex flex-col items-center bg-background px-6", children: [
    /* @__PURE__ */ jsxs47("div", { className: "flex-2 flex flex-col items-center justify-center w-full", children: [
      /* @__PURE__ */ jsx66("div", { className: "h-[15%] shrink-0" }),
      /* @__PURE__ */ jsx66(RdbIcon, {})
    ] }),
    /* @__PURE__ */ jsxs47("div", { className: "flex-[1.5] flex flex-col items-center justify-center w-full", children: [
      /* @__PURE__ */ jsx66("h2", { className: "text-[24px] font-semibold text-foreground text-center", children: t.auth.getStarted.title }),
      /* @__PURE__ */ jsx66("div", { className: "h-[2vh] shrink-0" }),
      /* @__PURE__ */ jsx66("p", { className: "text-[13px] leading-[1.6] text-foreground/70 text-center text-balance max-w-[320px]", children: t.auth.getStarted.description })
    ] }),
    /* @__PURE__ */ jsxs47("div", { className: "flex-[1.5] flex flex-col items-center justify-end w-full pb-10 gap-3", children: [
      /* @__PURE__ */ jsxs47("div", { className: "flex flex-col items-center gap-2.5 w-full max-w-87.5", children: [
        /* @__PURE__ */ jsx66(Button, { onClick: onExistingAccount, children: t.auth.getStarted.haveAccount }),
        /* @__PURE__ */ jsx66(Button, { onClick: onNewCustomer, children: t.auth.getStarted.newCustomer })
      ] }),
      /* @__PURE__ */ jsx66("div", { className: "h-[1vh] shrink-0" }),
      /* @__PURE__ */ jsx66(
        "button",
        {
          onClick: onLater,
...
import { Info as Info2, MessageSquare, Pencil, Loader2 as Loader23 } from "lucide-react";

// src/components/icons/svg.tsx
import { jsx as jsx67 } from "react/jsx-runtime";
var WhatsAppIcon = ({ className = "w-6 h-6" }) => /* @__PURE__ */ jsx67(
  "svg",
  {
    viewBox: "0 0 24 24",
    className,
...
function SelectMethod({
  ...
  return /* @__PURE__ */ jsx68(
    ...
    {
      title: authType === "signUp" ? t.auth.enterPhone.signUpTitle : t.auth.enterPhone.signInTitle,
      children: /* @__PURE__ */ jsxs48("div", { className: "w-full max-w-95 flex flex-col items-center gap-6", children: [
        /* @__PURE__ */ jsxs48("div", { className: "flex flex-col pb-12 items-center gap-2 text-center", children: [
          /* @__PURE__ */ jsxs48("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx68(Info2, { className: "w-4 h-4 text-gray-400" }),
            /* @__PURE__ */ jsx68("p", { className: "text-[13px] text-gray-500", children: t.auth.selectMethod.info })
          ] }),
          /* @__PURE__ */ jsxs48("p", { className: "text-[15px] font-semibold text-gray-800 flex items-center gap-2", children: [
            phone,
            " ",
            /* @__PURE__ */ jsx68(
              "span",
              {
                ...
                children: /* @__PURE__ */ jsx68(Pencil, { className: "w-3.5 h-3.5 text-blue-500 group-hover:text-blue-600" })
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxs48("div", { className: "flex gap-3 w-full justify-center mt-2", children: [
          /* @__PURE__ */ jsxs48(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx68(WhatsAppIcon, { className: "w-5 h-5" }),
                /* @__PURE__ */ jsx68("span", { className: "text-sm font-medium", children: t.auth.selectMethod.whatsapp })
              ]
            }
          ),
          /* @__PURE__ */ jsxs48(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx68(MessageSquare, { className: "w-5 h-5" }),
                /* @__PURE__ */ jsx68("span", { className: "text-sm font-medium", children: t.auth.selectMethod.sms })
              ]
            }
          )
        ] }),
        loading && /* @__PURE__ */ jsx68("div", { className: "absolute inset-0 rounded-lg bg-white/50 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsx68(Loader23, { className: "w-5 h-5 text-primary animate-spin" }) })
      ] })
    }
  );
}
...
import { ArrowLeftRight, Info as Info3, Loader2 as Loader24 } from "lucide-react";

// src/components/ui/PinInputs.tsx
import { useRef as useRef20, useState as useState30, useEffect as useEffect22 } from "react";
...
var PinInputs = ({
  ...
  const [pin, setPin] = useState30(Array(6).fill(""));
  const [focusedIndex, setFocusedIndex] = useState30(null);
  useEffect22(() => {
  ...
  return /* @__PURE__ */ jsx69("div", { className: "relative flex items-center justify-center mt-[min(2vw,0.92vh)] w-full", children: /* @__PURE__ */ jsx69("div", { className: `flex items-center justify-center gap-[min(2.32vw,1.07vh)] w-full`, children: pin.map((digit, i) => /* @__PURE__ */ jsxs49("div", { className: "relative w-[min(12.79vw,5.9vh)] aspect-square shrink-0", children: [
    /* @__PURE__ */ jsx69(
      "div",
      {
    ...
    digit && /* @__PURE__ */ jsx69("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsx69(
      Image23,
      {
        src: lock_default,
        alt: "lock",
    ...
    focusedIndex === i && !digit && isValidPin !== "valid" && isValidPin !== "notvalid" && /* @__PURE__ */ jsx69("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsx69("div", { className: "w-[7.2%] aspect-square bg-[#8E8E8E] rounded-full animate-blink" }) }),
    /* @__PURE__ */ jsx69(
      "input",
      {
        ref: (el) => {
...
function EnterPin({
  ...
  const [timeLeft, setTimeLeft] = useState31(120);
  const [canResend, setCanResend] = useState31(false);
  useEffect23(() => {
    if (timeLeft <= 0) {
      setCanResend(true);
      return;
  ...
  return /* @__PURE__ */ jsx70(AuthLayout, { title: t.auth.enterPin.title, showPhoneIcon: true, children: /* @__PURE__ */ jsxs50("div", { className: "relative w-full max-w-95 flex flex-col items-center gap-4", children: [
    /* @__PURE__ */ jsxs50("div", { className: "flex items-center gap-2 text-gray-500 text-[13px]", children: [
      /* @__PURE__ */ jsx70(Info3, { className: "w-4 h-4" }),
      /* @__PURE__ */ jsxs50("p", { children: [
        t.auth.enterPin.enterCodePrefix,
        method === "whatsapp" ? t.auth.enterPin.whatsapp : t.auth.enterPin.sms
      ] }),
      /* @__PURE__ */ jsx70("span", { onClick: changeMethod, className: "text-blue-500 cursor-pointer text-xs", children: /* @__PURE__ */ jsx70(ArrowLeftRight, { className: "w-3.5 h-3.5 text-blue-500 group-hover:rotate-180 transition-transform duration-300" }) })
    ] }),
    /* @__PURE__ */ jsxs50("p", { className: "font-bold text-gray-800", children: [
      "+",
      phone
    ] }),
    /* @__PURE__ */ jsx70(
    ...
    !canResend ? /* @__PURE__ */ jsxs50("div", { className: "text-[12px] text-gray-400 mt-2", children: [
      t.auth.enterPin.resendIn,
      " ",
      /* @__PURE__ */ jsx70("span", { className: "text-blue-500 font-bold", children: formatTime(timeLeft) })
    ] }) : /* @__PURE__ */ jsxs50("div", { className: "text-[12px] text-gray-400 mt-2 flex items-center gap-3", children: [
      /* @__PURE__ */ jsx70(
        "button",
        {
      ...
      loading === "resend-pin" && /* @__PURE__ */ jsx70(Loader24, { className: "w-4 h-4 text-primary animate-spin" })
    ] }),
    loading === "verify-pin" && /* @__PURE__ */ jsx70("div", { className: "absolute inset-0 rounded-lg bg-white/50 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ jsx70(Loader24, { className: "w-5 h-5 text-primary animate-spin" }) })
  ] }) });
}
...
function TermsScreen({ onAgree, onLater }) {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxs51("div", { className: "w-full h-full flex flex-col items-center bg-background px-10", children: [
    /* @__PURE__ */ jsxs51("div", { className: "flex-2 flex flex-col items-center justify-center w-full", children: [
      /* @__PURE__ */ jsx71("div", { className: "h-[20%] shrink-0" }),
      /* @__PURE__ */ jsx71(RdbIcon, {})
    ] }),
    /* @__PURE__ */ jsxs51("div", { className: "flex-[1.5] flex flex-col items-center justify-center w-full gap-6", children: [
      /* @__PURE__ */ jsxs51("p", { className: "text-[13px] leading-[1.6] text-foreground/70 text-center text-balance", children: [
        t.auth.terms.toCreate,
        /* @__PURE__ */ jsx71("span", { className: "font-semibold text-foreground", children: t.auth.terms.agreeAndContinueQuoted }),
        t.auth.terms.toAccept,
        /* @__PURE__ */ jsx71("br", {}),
        t.auth.terms.termsOfServices
      ] }),
      /* @__PURE__ */ jsxs51("div", { className: "flex flex-col items-center gap-2", children: [
        /* @__PURE__ */ jsx71("div", { className: "w-11 h-11 flex items-center justify-center", children: /* @__PURE__ */ jsx71(FileText, { className: "w-7 h-7 text-blue-600" }) }),
        /* @__PURE__ */ jsx71("span", { className: "text-[12px] text-blue-600 font-medium", children: t.auth.terms.termsLabel })
      ] })
    ] }),
    /* @__PURE__ */ jsxs51("div", { className: "flex-1 flex flex-col items-center justify-end w-full pb-10 gap-4", children: [
      /* @__PURE__ */ jsx71(Button, { onClick: onAgree, children: t.auth.terms.agreeButton }),
      /* @__PURE__ */ jsx71(
        "button",
        {
          onClick: onLater,
...
function AuthPage() {
  ...
  const { toast } = useToast();
  const { t, tr: tr2 } = useTranslation();
  const [authType, setAuthType] = useState32("signUp");
  const [isValidPin, setIsValidPin] = useState32("");
  const [step, setStep] = useState32("get-started");
  const [phone, setPhone] = useState32("");
  const [sessionInfo, setSessionInfo] = useState32("");
  const [method, setMethod] = useState32("");
  const [pin, setPin] = useState32("");
  const [loading, setLoading] = useState32("");
  ...
  return /* @__PURE__ */ jsxs52("main", { className: "w-full h-dvh bg-background overflow-hidden", children: [
    step === "get-started" && /* @__PURE__ */ jsx72(
      GetStartedScreen,
      {
        onNewCustomer: () => {
          setStep("terms");
    ...
    step === "terms" && /* @__PURE__ */ jsx72(TermsScreen, { onAgree: () => setStep("enter-phone") }),
    step === "enter-phone" && /* @__PURE__ */ jsx72(
      EnterPhoneScreen,
      {
        authType,
    ...
    step === "select-method" && /* @__PURE__ */ jsx72(
      SelectMethod,
      {
        changeNumber,
...
var typeConfig = {
  success: {
    ...
    icon: /* @__PURE__ */ jsx73("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: /* @__PURE__ */ jsx73(
      "path",
      {
  ...
  warn: {
    ...
    icon: /* @__PURE__ */ jsx73("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: /* @__PURE__ */ jsx73("path", { d: "M1 18h18L10 1 1 18zm10-3H9v-2h2v2zm0-4H9V7h2v4z", fill: "#F59E0B" }) })
  },
  info: {
    color: "#388CFF",
...
var Toast = ({ toast, theme, onRemove, onPause, onResume }) => {
  const [isExiting, setIsExiting] = useState33(false);
  const [progress, setProgress] = useState33(100);
      ...
      children: [
        ...
        /* @__PURE__ */ jsx73(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx73("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ jsx73(
              "path",
              {
        ...
        toast.showProgress && /* @__PURE__ */ jsx73(
          "div",
          {
...
var ToastContainer = () => {
  ...
  return /* @__PURE__ */ jsx74("div", { className: `fixed top-6 z-50 ${rtl ? "left-6" : "right-6"}`, children: /* @__PURE__ */ jsx74("div", { className: "relative", children: toasts.map((toast, index) => {
...
import React33, { useEffect as useEffect25, useState as useState34 } from "react";
...
var AnimatedLoader = ({
  ...
  const [percent, setPercent] = useState34(0);
  const onCompleteRef = React33.useRef(onComplete);
  useEffect25(() => {
  ...
  return /* @__PURE__ */ jsx75(LoaderBarIcon, { percent, className });
};
...
var AnimatedTagline = ({
  ...
  const { rtl } = useTranslation();
  const [index, setIndex] = useState35(0);
  const [isStarted, setIsStarted] = useState35(false);
  useEffect26(() => {
  ...
  return /* @__PURE__ */ jsx76(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx76(AnimatePresence5, { mode: "wait", children: isStarted && /* @__PURE__ */ jsx76(
        motion5.div,
        {
          ...
          children: words[index].split("").map((char, i) => /* @__PURE__ */ jsx76(
            motion5.span,
            {
...
function SplashScreen({ onComplete }) {
  const duration = 4e3;
  return /* @__PURE__ */ jsx77("main", { className: "w-full h-full flex items-center justify-center overflow-hidden bg-background", children: /* @__PURE__ */ jsxs54("div", { className: "aspect-430/932 h-full max-h-full w-auto max-w-full flex flex-col items-center relative", children: [
    /* @__PURE__ */ jsx77("div", { className: "h-[42.81%] shrink-0 w-full" }),
    /* @__PURE__ */ jsx77("div", { className: "w-[32.09%] shrink-0", children: /* @__PURE__ */ jsx77(RdbIcon, { className: "text-foreground w-full h-auto" }) }),
    /* @__PURE__ */ jsx77("div", { className: "h-[21.67%] shrink-0 w-full" }),
    /* @__PURE__ */ jsx77("div", { className: "w-[33.95%] shrink-0", children: /* @__PURE__ */ jsx77(
      AnimatedLoader,
      {
        duration,
        onComplete,
    ...
    /* @__PURE__ */ jsx77("div", { className: "h-[18.24%] shrink-0 flex flex-col justify-end w-full items-center pb-[1%]", children: /* @__PURE__ */ jsx77(
      AnimatedTagline,
      {
    ...
    /* @__PURE__ */ jsx77("div", { className: "w-[23.78%] shrink-0 aspect-[102.25/27.65]", children: /* @__PURE__ */ jsx77(Icon, { name: "ramaaztech", className: "text-foreground w-full h-full" }) }),
    /* @__PURE__ */ jsx77("div", { className: "h-[3.33%] shrink-0 w-full" })
  ] }) });
}
...
function RDB(props) {
  ...
  const [cookieConfig, setCookieConfig] = useState36({
    local: null,
    baseUrl: null
  });
  const [isConfigLoaded, setIsConfigLoaded] = useState36(false);
  const [userData, setUserData] = useState36(null);
  const [loading, setLoading] = useState36(true);
  const [splashDone, setSplashDone] = useState36(false);
  ...
  return /* @__PURE__ */ jsx78(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx78(I18nProvider, { locale: local, children: /* @__PURE__ */ jsx78(AuthProvider, { userData, useCookies: false, children: /* @__PURE__ */ jsx78(
        RDBProvider,
        {
          config: {
            baseUrl,
          ...
          actions,
          children: /* @__PURE__ */ jsx78(StoreProvider, { children: /* @__PURE__ */ jsx78(ScannerProvider, { children: /* @__PURE__ */ jsx78(RDBLayout, { onSplashCompleteAction: handleSplashComplete, children: /* @__PURE__ */ jsx78(LayoutProvider, { children: /* @__PURE__ */ jsx78(ToastProvider, { children: showSplash ? /* @__PURE__ */ jsx78(SplashScreen, { onComplete: () => setSplashDone(true) }) : /* @__PURE__ */ jsx78(MemoryRouter, { initialEntries: ["/"], children: /* @__PURE__ */ jsxs55(LibraryRouterAdapter, { children: [
            /* @__PURE__ */ jsxs55(Routes, { children: [
              /* @__PURE__ */ jsx78(Route, { path: "/auth", element: /* @__PURE__ */ jsx78(AuthPage, {}) }),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/home",
                  element: /* @__PURE__ */ jsx78(ProtectedLayout, { children: /* @__PURE__ */ jsx78(HomePage, {}) })
                }
              ),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/transactions",
                  element: /* @__PURE__ */ jsx78(ProtectedLayout, { children: /* @__PURE__ */ jsx78(TransactionsPage, {}) })
                }
              ),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/addresses",
                  element: /* @__PURE__ */ jsx78(ProtectedLayout, { children: /* @__PURE__ */ jsx78(AddressesPage, {}) })
                }
              ),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/settings",
                  element: /* @__PURE__ */ jsx78(ProtectedLayout, { children: /* @__PURE__ */ jsx78(SettingsPage, {}) })
                }
              ),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/auth",
                  element: /* @__PURE__ */ jsx78(ProtectedLayout, { children: /* @__PURE__ */ jsx78(AuthPage, {}) })
                }
              ),
              /* @__PURE__ */ jsx78(
                Route,
                {
                  path: "/",
                  element: /* @__PURE__ */ jsx78(Navigate, { to: "/home", replace: true })
                }
              )
            ] }),
            /* @__PURE__ */ jsx78(ToastContainer_default, {})
          ] }) }) }) }) }) }) })
        }
      ) }) })
    }
